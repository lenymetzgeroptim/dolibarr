...
/**
 *   	\file       UserGroup_History.php
 *		\ingroup    addonusergroup
 *		\brief      Page to view history of user group
 */
...
$langs->loadLangs(array("addonusergroup@addonusergroup", "suppliers", "other"));
...
// Security check
if (empty($conf->addonusergroup->enabled)) {
...
$title = $object->name.' - '.$langs->trans('History');
$help_url = '';
...
if($id > 0 && $permissiontoread){
	...
	print dol_get_fiche_head($head, 'usergroup_history', $langs->trans("UserGroup"), -1, $object->picto);
    ...
    print $object->array_options['options_history'];
}
