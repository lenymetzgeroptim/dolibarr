...
/**
 *   	\file       rgpd_element_list.php
 *		\ingroup    rgpd
 *		\brief      List page for rgpd_element
 */
...
require_once __DIR__.'/class/rgpd_element.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('rgpd', 'rgpd_element', 'write');
	$permissiontodelete = $user->hasRight('rgpd', 'rgpd_element', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Rgpd_element';
	$objectlabel = 'Rgpd_element';
...
$title = $langs->trans("Rgpd_elements");
//$help_url = "EN:Module_Rgpd_element|FR:Module_Rgpd_element_FR|ES:Módulo_Rgpd_element";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/rgpd/rgpd_element_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/rgpd/rgpd_element_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendRgpd_elementRef";
$modelmail = "rgpd_element";
$objecttmp = new Rgpd_element($db);
