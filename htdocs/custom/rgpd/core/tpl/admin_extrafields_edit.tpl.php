...
<!-- Onglet -->
<?php
	$param_list[0] = 'AdminRgpd:custom/adminrgpd/class/adminrgpd.class.php'; // $param_list='ObjectName:classPath[:AddCreateButtonOrNot[:Filter[:Sortfield]]]'
...
?>
<tr class="extra_groupes"><td class="fieldrequired"><?php echo $langs->trans("Admin RGPD"); ?></td><td><?php echo $out; ?></td></tr>
