...
/**
 * \file    test/phpunit/FODFunctionalTest.php
 * \ingroup fod
 ...
 * @package Testfod
 */
class FODFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/fod/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('fod/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/fod/admin/about.php');
		$this->authenticate();
		return $this->assertContains('fod/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('fodwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modFOD_FODTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFOD_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
