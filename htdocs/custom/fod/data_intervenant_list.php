...
/**
 *   	\file       data_intervenant_list.php
 *		\ingroup    fod
 *		\brief      List page for data_intervenant
 */
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Data_intervenant';
	$objectlabel = 'Data_intervenant';
...
//$help_url="EN:Module_Data_intervenant|FR:Module_Data_intervenant_FR|ES:Módulo_Data_intervenant";
$help_url = '';
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/fod/data_intervenant_card.php', 1).'?id='.$id);
	exit;
}
...
/*$topicmail = "SendData_intervenantRef";
$modelmail = "data_intervenant";
$objecttmp = new Data_intervenant($db);
