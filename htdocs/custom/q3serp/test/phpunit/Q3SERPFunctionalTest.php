...
/**
 * \file    test/phpunit/Q3SERPFunctionalTest.php
 * \ingroup q3serp
 ...
 * @package Testq3serp
 */
class Q3SERPFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 661002; // TODO: autodetect?
	...
	{
		$this->url('/custom/q3serp/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('q3serp/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/q3serp/admin/about.php');
		$this->authenticate();
		return $this->assertContains('q3serp/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('q3serpwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modQ3SERP_Q3SERPTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modQ3SERP_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
