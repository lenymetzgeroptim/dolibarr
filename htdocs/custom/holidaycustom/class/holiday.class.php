...
require DOL_DOCUMENT_ROOT.'/lib/vendor/autoload.php';
        ...
        foreach ($worksheet->getRowIterator() as $row) { // On parcours toutes les lignes du fichier excel
            if($i > 3){ // On ignore la 1ere ligne (titres)
                ...
                if (!empty($matricule)){
                    ...
                    $acquis_Frac = (!empty($spreadsheet->getActiveSheet()->getCellByColumnAndRow(10, $i)->getValue()) ? $spreadsheet->getActiveSheet()->getCellByColumnAndRow(10, $i)->getValue() : 0);
                    $pris_Frac = (!empty($spreadsheet->getActiveSheet()->getCellByColumnAndRow(11, $i)->getValue()) ? $spreadsheet->getActiveSheet()->getCellByColumnAndRow(11, $i)->getValue() : 0);
                    $solde_Frac = (!empty($spreadsheet->getActiveSheet()->getCellByColumnAndRow(12, $i)->getValue()) ? $spreadsheet->getActiveSheet()->getCellByColumnAndRow(12, $i)->getValue() : $acquis_Frac - $pris_Frac);
                    $acquis_Anc = (!empty($spreadsheet->getActiveSheet()->getCellByColumnAndRow(13, $i)->getValue()) ? $spreadsheet->getActiveSheet()->getCellByColumnAndRow(13, $i)->getValue() : 0);
                    $pris_Anc = (!empty($spreadsheet->getActiveSheet()->getCellByColumnAndRow(14, $i)->getValue()) ? $spreadsheet->getActiveSheet()->getCellByColumnAndRow(14, $i)->getValue() : 0);
                    $solde_Anc = (!empty($spreadsheet->getActiveSheet()->getCellByColumnAndRow(15, $i)->getValue()) ? $spreadsheet->getActiveSheet()->getCellByColumnAndRow(15, $i)->getValue() : $acquis_Anc - $pris_Anc);
                    $acquis_RTT = (!empty($spreadsheet->getActiveSheet()->getCellByColumnAndRow(16, $i)->getValue()) ? $spreadsheet->getActiveSheet()->getCellByColumnAndRow(16, $i)->getValue() : 0);
                    $pris_RTT = (!empty($spreadsheet->getActiveSheet()->getCellByColumnAndRow(17, $i)->getValue()) ? $spreadsheet->getActiveSheet()->getCellByColumnAndRow(17, $i)->getValue() : 0);
                    $solde_RTT = (!empty($spreadsheet->getActiveSheet()->getCellByColumnAndRow(18, $i)->getValue()) ? $spreadsheet->getActiveSheet()->getCellByColumnAndRow(18, $i)->getValue() : $acquis_RTT - $pris_RTT);
