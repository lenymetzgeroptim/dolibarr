...
$langs->loadLangs(array('other', 'holiday', 'companies', "holidaycustom@holidaycustom"));
...
$upload_dir = str_replace('custom', '', $conf->holidaycustom->dir_output).'/'.get_exdir(0, 0, 0, 1, $object, '');
$modulepart = 'holiday';
...
$result = restrictedArea($user, 'holidaycustom', $object->id, 'holiday');

$permissiontoadd = $user->rights->holidaycustom->write; // Used by the include of actions_setnotes.inc.php
...
if ($object->id) {
	...
	$permissiontoadd = $user->rights->holidaycustom->write;
	$permtoedit = $user->rights->holidaycustom->write;
	$param = '&id='.$object->id;
