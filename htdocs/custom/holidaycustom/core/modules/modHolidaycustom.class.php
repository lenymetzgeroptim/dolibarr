...
class modHolidaycustom extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->dictionaries = array(
			...
			'tabsql'=>array("SELECT h.rowid as rowid, h.code, h.code_silae, h.label, h.affect, h.delay, h.newbymonth, h.fk_country as country_id, h.in_hour, c.code as country_code, c.label as 
			...
			'tabfield'=>array("code,code_silae,label,affect,delay,newbymonth,country_id,in_hour,country"),
			// List of fields (list of fields to edit a record)
			'tabfieldvalue'=>array("code,code_silae,label,affect,delay,newbymonth,in_hour,country"),
			// List of fields (list of fields for insert)
			'tabfieldinsert'=>array("code,code_silae,label,affect,delay,newbymonth,in_hour,fk_country"),
