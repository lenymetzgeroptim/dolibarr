...
// 					if(!empty($objecttmp->array_options['options_fk_validator2'])){
// 						$objecttmp->statut = Holiday::STATUS_APPROVED1;
// 					}
// 				 }

// 				 if (($objecttmp->statut == Holiday::STATUS_APPROVED1 && $user->id == $objecttmp->array_options['options_fk_validator2']) || ($objecttmp->statut == Holiday::STATUS_VALIDATED && $user->id == $objecttmp->fk_validator)) {
// 					$objecttmp->statut = Holiday::STATUS_APPROVED2; 
// 				}
