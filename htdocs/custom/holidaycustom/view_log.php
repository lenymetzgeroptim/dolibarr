...
if (empty($user->rights->holidaycustom->define_holiday) || $user->socid > 0) {
	accessforbidden();
}
...
if (!$user->rights->holidaycustom->readall) {
	accessforbidden();
}

// Load translation files required by the page
$langs->loadLangs(array('users', 'other', 'holiday', "holidaycustom@holidaycustom"));
