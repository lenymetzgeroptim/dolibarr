...
/**
 * \file    test/phpunit/ActionsFunctionalTest.php
 * \ingroup actions
 ...
 * @package Testactions
 */
class ActionsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 500034; // TODO: autodetect?
	...
	{
		$this->url('/custom/actions/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('actions/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/actions/admin/about.php');
		$this->authenticate();
		return $this->assertContains('actions/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('actionswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modActions_ActionsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modActions_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
