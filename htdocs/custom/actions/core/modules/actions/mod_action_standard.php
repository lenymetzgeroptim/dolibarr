...
/**
 *  \file       htdocs/core/modules/actions/mod_action_standard.php
 *  \ingroup    actions
...
/**
 *	Class to manage the Standard numbering rule for Action
 */
class mod_action_standard extends ModeleNumRefAction
{
	...
	public function canBeActivated($object)
	{
		...
		$sql .= " FROM ".MAIN_DB_PREFIX."actions_actionq3se";
