...
/**
 *  \file       core/modules/actions/doc/pdf_standard.modules.php
 *  \ingroup    actions
...
/**
 *	Class to manage PDF template standard_action
 */
class pdf_standard_action extends ModelePDFAction
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
		...
		if ($conf->actions->dir_output.'/action') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->actions->dir_output.'/action';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->actions->dir_output.'/action/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('ACTIONS_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('ACTIONS_DRAFT_WATERMARK')));
		}
