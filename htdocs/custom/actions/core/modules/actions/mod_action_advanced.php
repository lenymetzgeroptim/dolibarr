...
/**
 * \file       htdocs/core/modules/actions/mod_action_advanced.php
 * \ingroup    actions
...
/**
 *	Class to manage the Advanced numbering rule for Action
 */
class mod_action_advanced extends ModeleNumRefAction
{
	...
	public function info()
	{
		...
		$texte .= '<input type="hidden" name="maskconst" value="ACTIONS_MYOBJECT_ADVANCED_MASK">';
		...
		$texte .= '<td class="right">'.$form->textwithpicto('<input type="text" class="flat minwidth175" name="maskvalue" value="'.getDolGlobalString('ACTIONS_MYOBJECT_ADVANCED_MASK').'">', $tooltip, 1, 1).'</td>';
	...
	public function getNextValue($object)
	{
		...
		// We get cursor rule
		$mask = getDolGlobalString('ACTIONS_MYOBJECT_ADVANCED_MASK');
