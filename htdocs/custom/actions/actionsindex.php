...
/**
 *	\file       actions/actionsindex.php
 *	\ingroup    actions
 *	\brief      Home page of actions top menu
 */
...
$langs->loadLangs(array("actions@actions"));
...
//}
//if (! $user->hasRight('actions', 'myobject', 'read')) {
//	accessforbidden();
//}
//restrictedArea($user, 'actions', 0, 'actions_myobject', 'myobject', '', 'rowid');
//if (empty($user->admin)) {
...
llxHeader("", $langs->trans("ActionsArea"));

print load_fiche_titre($langs->trans("ActionsArea"), '', 'actions.png@actions');
...
if (isModEnabled('actions') && $user->rights->actions->read)
{
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."actions_myobject as s";
	//if (! $user->rights->societe->client->voir && ! $socid) $sql.= ", ".MAIN_DB_PREFIX."societe_commerciaux as sc";
