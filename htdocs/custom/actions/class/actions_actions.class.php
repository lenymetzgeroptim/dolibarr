...
class ActionsActions
{
	...
	public function showLinkedObjectBlock($parameters, &$object, &$action, $hookmanager)
	{
		...
		/* print_r($parameters); print_r($object); echo "action: " . $action; */
		if (in_array($parameters['currentcontext'], array('constatLinked'))) {		// do something only for the context 'somecontext1' or 'somecontext2'
			// $this->resprints = '<option value="0"'.($disabled ? ' disabled="disabled"' : '').'>'.$langs->trans("ActionsMassAction").'</option>';
	...
	function doActions($parameters, &$object, &$action, $hookmanager)
	{
		...
		if (in_array('constatLinked', explode(':', $parameters['context'])))
		{
