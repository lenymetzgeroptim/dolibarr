...
$langs->loadLangs(array("actions@actions", "companies", "other", "mails"));
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->actions->multidir_output[$object->entity ? $object->entity : $conf->entity]."/action/".get_exdir(0, 0, 0, 1, $object);
}
...
$permissiontoadd = 1;
//$permtoedit = $user->rights->actions->action->write;
$permtoedit = 1;
$param = '&id='.$object->id;
