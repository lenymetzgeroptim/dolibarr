...
/**
 *       \file       /custom/feuilledetemps/export.php
 *       \ingroup    export
...
// 	);
// 	if(isset($user_extrafields->attributes['user']['type']['matricule'])) {
// 		$objexport->array_tablename[0]["eu.matricule"] = "llx_user_extrafields";
// 	}
// 	if(isset($user_extrafields->attributes['user']['type']['etablissement'])) {
// 		$objexport->array_tablename[0]["eu.etablissement"] = "llx_user_extrafields";
// 	}
// 	if(isset($user_extrafields->attributes['user']['type']['antenne'])) {
// 		$objexport->array_tablename[0]["eu.antenne"] = "llx_user_extrafields";
// 	}
// }
// else {
// 	$objexport->array_tablename[0][0] = array(
// 		"u.firstname" => "llx_user",
// 		"u.lastname" => "llx_user",
// 		"jour" => "llx_element_time",
// 		"element_date" => "llx_element_time",
...
// 	);
// 	if(isset($user_extrafields->attributes['user']['type']['matricule'])) {
// 		$objexport->array_tablename[0][0]["eu.matricule"] = "llx_user_extrafields";
// 	}
// 	if(isset($user_extrafields->attributes['user']['type']['etablissement'])) {
// 		$objexport->array_tablename[0][0]["eu.etablissement"] = "llx_user_extrafields";
// 	}
// 	if(isset($user_extrafields->attributes['user']['type']['antenne'])) {
// 		$objexport->array_tablename[0][0]["eu.antenne"] = "llx_user_extrafields";
// 	}
// }
...
if($datatoexport == 'heure_nuit_dimanche')  {
	...
	$objexport->array_export_code[0] = 'heure_nuit_dimanche';
	$objexport->array_export_label[0] = "Heures de nuit et du dimanche";
...
if ($action == 'builddoc') {
	...
	// Build export file
	$result = $objexport->build_file($user, GETPOST('model', 'alpha'), $datatoexport, $array_selected, $array_filtervalue, $sqlquery, $separator);
	if ($result < 0) {
...
if ($step == 4 && $datatoexport) {
	...
	if (count($array_selected)) {
		...
		print '<form class="nocellnopadd" action="'.$link.'" method="post">';
		print '<input type="hidden" name="token" value="'.newToken().'">';
