...
/**
 *   	\file       observationcompta_list.php
 *		\ingroup    feuilledetemps
 *		\brief      List page for observationcompta
 */
...
require_once __DIR__.'/class/observationcompta.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('feuilledetemps', 'observationcompta', 'write');
	$permissiontodelete = $user->hasRight('feuilledetemps', 'observationcompta', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (!isModEnabled("feuilledetemps")) {
	accessforbidden('Module feuilledetemps not enabled');
}
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'ObservationCompta';
	$objectlabel = 'ObservationCompta';
...
$title = $langs->trans("ObservationComptas");
//$help_url = "EN:Module_ObservationCompta|FR:Module_ObservationCompta_FR|ES:Módulo_ObservationCompta";
$help_url = '';
$morejs = array();
$morecss = array();
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/feuilledetemps/observationcompta_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendObservationComptaRef";
$modelmail = "observationcompta";
$objecttmp = new ObservationCompta($db);
