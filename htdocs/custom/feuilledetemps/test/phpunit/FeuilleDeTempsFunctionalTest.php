...
/**
 * \file    test/phpunit/FeuilleDeTempsFunctionalTest.php
...
/**
 * Class FeuilleDeTempsFunctionalTest
 *
 ...
 *
 * @package Testfeuilledetemps
 */
class FeuilleDeTempsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modFeuilleDeTemps')->click();
		} else {
			// Disable the module
			$this->byHref('modFeuilleDeTemps')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/feuilledetemps/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('feuilledetemps/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/feuilledetemps/admin/about.php');
		$this->authenticate();
		return $this->assertContains('feuilledetemps/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('feuilledetempswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modFeuilleDeTemps_FeuilleDeTempsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFeuilleDeTemps_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
