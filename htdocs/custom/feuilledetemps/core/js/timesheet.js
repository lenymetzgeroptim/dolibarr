...
function updateTotalWeek(temps_prec = 0, temps_suiv = 0, weekNumber, timeHoliday, heure_semaine) {
    ...
    var color = "";
    if ((morehours + totalhour) * 60 + totalmin < ((heure_semaine - timeHoliday) * 60) && timeHoliday != 5 * HEURE_JOUR) {
        color = "red";
    }
    else if ((morehours + totalhour) * 60 + totalmin > ((heure_semaine - timeHoliday) * 60)) {
        color = "#3d85c6";
    }
