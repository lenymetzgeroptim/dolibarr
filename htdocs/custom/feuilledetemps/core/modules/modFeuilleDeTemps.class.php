	...
	public function __construct($db)
	{
		...
		$this->tabs = array(
		        'data'=>'project:+timespent_heure_sup:Temps consommé (HS):feuilledetemps@feuilledetemps:1:/feuilledetemps/time_heure_sup.php?withproject=1&projectid=__ID__',
		                ...
		                'project:-element::1',
						'project:+report:projectReport:feuilledetemps@feuilledetemps:$user->rights->feuilledetemps->timespent->readall:/feuilledetemps/rapport_projet.php?projectSelected=__ID__',
		...
		*/
		...
		$this->menu[$r++]=array(
			...
			'perms'=>'$user->rights->feuilledetemps->timespent->readall',                                        // Use 'perms'=>'$user->rights->feuilledetemps->level1->level2' if you want your menu with a permission rules
			'target'=>'',
			'user'=>2,
		);
