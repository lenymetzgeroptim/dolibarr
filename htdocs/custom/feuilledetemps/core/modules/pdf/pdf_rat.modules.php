...
require_once DOL_DOCUMENT_ROOT.'/custom/feuilledetemps/core/modules/modules_timesheet.php';
...
public function writeFile($object, $outputlangs)
{
    ...
    $outputlangs->load("feuilledetemps@feuilledetemps");

    //get save dir
    if($conf->projet->dir_output) {
        $objectref =  dol_sanitizeFileName($object->name);
        $dir = $conf->feuilledetemps->dir_output.'/reports/';
