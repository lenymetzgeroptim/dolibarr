...
/**
 *  \file       core/modules/feuilledetemps/doc/pdf_standard.modules.php
 *  \ingroup    feuilledetemps
 *  \brief      File of class to generate document from standard template
 */

dol_include_once('/feuilledetemps/core/modules/feuilledetemps/modules_feuilledetemps.php');
...
/**
 *	Class to manage PDF template standard_feuilledetemps
 */
class pdf_standard_feuilledetemps extends ModelePDFFeuilledetemps
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "pdf_standard_feuilledetemps";
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		if (!empty($conf->global->PDF_USE_ALSO_LANGUAGE_CODE) && $outputlangs->defaultlang != $conf->global->PDF_USE_ALSO_LANGUAGE_CODE) {
			...
			$outputlangsbis->loadLangs(array("main", "bills", "products", "dict", "companies", "feuilledetemps@feuilledetemps"));
		}
		...
		*/
		...
		if ($conf->feuilledetemps->dir_output.'/feuilledetemps') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->feuilledetemps->dir_output.'/feuilledetemps';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->feuilledetemps->dir_output.'/feuilledetemps/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		$outputlangs->loadLangs(array("main", "bills", "propal", "companies", "feuilledetemps@feuilledetemps"));
		...
		$title = $outputlangs->transnoentities("PdfTitleHistorique");
		...
		$pdf->WriteHTML('<hr color="#00285e" style="padding: 0px; margin: 0px;">');
