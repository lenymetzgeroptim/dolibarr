...
dol_include_once('/feuilledetemps/lib/feuilledetemps.lib.php');
...
$hookmanager->initHooks(array('feuilledetempscardinfo'));
...
if (!empty($object->id)) {
	...
	show_actions_messaging_custom($conf, $langs, $db, $object, null, 0, $actioncode, '', $filters, $sortfield, $sortorder, $exclude_actioncode);
}
