...
--ALTER TABLE llx_feuilledetemps_projet_task_time_other ADD CONSTRAINT llx_feuilledetemps_projet_task_time_other_fk_field FOREIGN KEY (fk_field) REFERENCES llx_feuilledetemps_myotherobject(rowid);
