...
if (!empty($conf->use_javascript_ajax)) {
	...
	// '/custom/workload/css/workload.css.php',
	// '/custom/workload/js/filter_resources.js.php',
	'/custom/workload/js/nav_resources.js.php'
	// '/custom/workload/js/fetch_resources.js.php'
	);
}
...
// HTML Pour le filtre
include_once DOL_DOCUMENT_ROOT.'/custom/workload/js/gantts_filter.js.php';
include_once DOL_DOCUMENT_ROOT.'/custom/workload/js/gantts_navigation.js.php';
