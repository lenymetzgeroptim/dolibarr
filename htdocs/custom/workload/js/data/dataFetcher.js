...
//     async function fetchAllData() {
//         try {
//             const [newData, newFilterData] = await Promise.all([
//                 fetchData(),
//                 fetchFilterData()
//             ]);

//             let dataChanged = !deepEqual(newData, Workload.Cache.lastData);
//             let filterChanged = !deepEqual(newFilterData, Workload.Cache.lastFilterData);

//             // Mise à jour du cache
//             if (dataChanged) {
//                 Workload.Cache.lastData = newData;
//             }
//             if (filterChanged) {
//                 Workload.Cache.lastFilterData = newFilterData;
//             }

//             return {
//                 data: dataChanged ? newData : null,
//                 filterData: filterChanged ? newFilterData : null
//             };
