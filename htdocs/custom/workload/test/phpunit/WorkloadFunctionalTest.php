...
/**
 * \file    test/phpunit/WorkloadFunctionalTest.php
 * \ingroup workload
 ...
 */
class WorkloadFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 500036; // TODO: autodetect?
	...
	{
		$this->url('/custom/workload/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('workload/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/workload/admin/about.php');
		$this->authenticate();
		return $this->assertContains('workload/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('workloadwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modWorkload_WorkloadTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modWorkload_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
