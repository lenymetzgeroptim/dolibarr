...
/**
 *  \file       core/modules/workload/doc/pdf_standard.modules.php
 *  \ingroup    workload
...
/**
 *	Class to manage PDF template standard_charge
 */
class pdf_standard_charge extends ModelePDFCharge
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
		...
		if ($conf->workload->dir_output.'/charge') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->workload->dir_output.'/charge';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->workload->dir_output.'/charge/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('WORKLOAD_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('WORKLOAD_DRAFT_WATERMARK')));
		}
