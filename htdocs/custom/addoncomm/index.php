...
require_once DOL_DOCUMENT_ROOT.'/custom/addoncomm/class/commande.class.php';
require_once DOL_DOCUMENT_ROOT.'/custom/addoncomm/class/suppliercommande.class.php';
$comcommande = new ElementCommande($db);
$suppliercom = new ElementSupplierCom($db);
$comcommande->fetch_commande();
$suppliercom->fetch_c_fournisseur();
$commGraph = new LineDolGraph($db);

$tmp = $commGraph->getCustomerOrderLineChart($socid);
if ($tmp) {
	print $tmp;
	print '<br>';
}
