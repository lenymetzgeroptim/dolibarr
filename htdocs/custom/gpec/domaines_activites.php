...
$tabname = MAIN_DB_PREFIX."gpec_domaines";
$tablib = "Domaines d'activités";
$tabsql = 'SELECT f.rowid as rowid, f.fk_theme, f.nom, f.activite, f.exigence_cctp, f.active, t.nom as nom_theme FROM '.MAIN_DB_PREFIX.'gpec_domaines as f LEFT JOIN '.MAIN_DB_PREFIX."gpec_theme_compDomaine as t ON t.rowid = f.fk_theme";
$tabsqlsort = "fk_theme ASC, nom ASC";
$tabfield = "fk_theme,nom,activite,exigence_cctp";
$tabfieldvalue = "fk_theme,nom,activite,exigence_cctp";
$tabfieldinsert = "fk_theme,nom,activite,exigence_cctp";
$tabrowid = "rowid";
...
$title = $langs->trans("Domaines d'activités");
...
function fieldList($fieldlist, $obj = '', $tabname = '', $context = '')
{
	...
	foreach ($fieldlist as $field => $value) {
		...
		if($value == "activite" || $value == "exigence_cctp"){
		...
		elseif($value == 'fk_theme') {
			...
			$sql .= " FROM ".MAIN_DB_PREFIX."gpec_theme_compDomaine";
			$sqlwhere .= ' WHERE 1=1';
