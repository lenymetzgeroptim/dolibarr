...
/**
 * \file    test/phpunit/GPECFunctionalTest.php
 * \ingroup gpec
 ...
 * @package Testgpec
 */
class GPECFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/gpec/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('gpec/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/gpec/admin/about.php');
		$this->authenticate();
		return $this->assertContains('gpec/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('gpecwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modGPEC_GPECTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modGPEC_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
