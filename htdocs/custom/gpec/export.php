...
require_once DOL_DOCUMENT_ROOT.'/custom/gpec/class/extendedexport.class.php';
...
$objexport = new ExtendedExport($db);
...
if(empty($datatoexport) && $export_code >= 0) {
	if($export_code == '0') {
		$datatoexport = 'gpec_competence_domaine';
	}
	elseif($export_code == '1') {
		$datatoexport = 'gpec_competence_transverse';
	}
	elseif($export_code == '2') {
		$datatoexport = 'gpec_matrice_competence';
	}
}


// Security check
if (!$user->rights->gpec->gpec->export) {
	accessforbidden();
}
...
if($datatoexport == 'gpec_matrice_competence') {
	$array_export_fields[0] = array(
		...
		"anciennete_optim" => "Ancienneté chez OPTIM Industries",
		"gmc.anciennete_metier" => "Ancienneté dans le métier",
		"gmc.diplome" => "Diplôme",
		"gmc.classification_pro" => "Classification professionnelle",
		"gmc.is_td" => "TD",
		"gmc.is_t" => "T",
		"gmc.is_te" => "TE",
		"gmc.is_tc" => "TC",
		...
		"gmc.is_ic" => "IC",
		"gmc.is_ie" => "IE",
		"gmc.chef_projet" => "Chef de projet",
		"gmc.pilote_affaire" => "Pilote d'affaire",
		"gmc.ingenieur_confirme" => "Ingénieur Confirmé",
		"gmc.preparateur_charge_affaire" => "Préparateur chargé d'affaire ancrage/supportage",
		"gmc.preparateur_methodes" => "Préparateur méthodes",
		"gmc.charge_affaires_elec_auto" => "Chargé d'affaires PIAT électricité/automatisme",
		"gmc.electricien" => "Electricien",
		"gmc.charge_affaires_mecanique" => "Chargé d'affaires PIAT mécanique",
		"gmc.mecanicien" => "Mécanicien",
		"gmc.robinettier" => "Robinettier",
		"gmc.pcr_operationnel" => "PCR opérationnel",
		"gmc.technicien_rp" => "Technicien RO",
		"gmc.charge_affaires_multi_specialites" => "Chargé d'affaires multi-spécialités",
		"gmc.mec_machine_tournante" => "Mécanique Machine Tournante",
		"gmc.robinetterie" => "Robinetterie",
		"gmc.chaudronnerie" => "Chaudonnerie",
		"gmc.tuyauterie_soudage" => "Tuyauterie/Soudage",
		"gmc.automatisme" => "Automatisme",
		"gmc.electricite" => "Electricité",
		"gmc.ventilation" => "Ventilation",
		"gmc.logistique" => "Logistique",
		"gmc.securite" => "Sécurité",
		"gmc.soudage" => "Soudage"
	);
}
else {
...
if($datatoexport == 'gpec_matrice_competence') {
	$array_export_entities[0] = array(
		...
		"u.lastname" => "user",
		"ug.nom" => "user",
		"g.status" => "gpec_16@gpec",
		"eu.employeur" => "user",
		"u.dateemployment" => "user",
		"anciennete_optim" => "user",
		"gmc.anciennete_metier" => "gpec_16@gpec",
		"gmc.diplome" => "gpec_16@gpec",
		"gmc.classification_pro" => "gpec_16@gpec",
		"gmc.is_td" => "gpec_16@gpec",
		"gmc.is_t" => "gpec_16@gpec",
		"gmc.is_te" => "gpec_16@gpec",
		"gmc.is_tc" => "gpec_16@gpec",
		"gmc.is_id" => "gpec_16@gpec",
		"gmc.is_i" => "gpec_16@gpec",
		"gmc.is_ic" => "gpec_16@gpec",
		"gmc.is_ie" => "gpec_16@gpec",
		"gmc.chef_projet" => "gpec_16@gpec",
		"gmc.pilote_affaire" => "gpec_16@gpec",
		"gmc.ingenieur_confirme" => "gpec_16@gpec",
		"gmc.preparateur_charge_affaire" => "gpec_16@gpec",
		"gmc.preparateur_methodes" => "gpec_16@gpec",
		"gmc.charge_affaires_elec_auto" => "gpec_16@gpec",
		"gmc.electricien" => "gpec_16@gpec",
		"gmc.charge_affaires_mecanique" => "gpec_16@gpec",
		"gmc.mecanicien" => "gpec_16@gpec",
		"gmc.robinettier" => "gpec_16@gpec",
		"gmc.pcr_operationnel" => "gpec_16@gpec",
		"gmc.technicien_rp" => "gpec_16@gpec",
		"gmc.charge_affaires_multi_specialites" => "gpec_16@gpec",
		"gmc.mec_machine_tournante" => "gpec_16@gpec",
		"gmc.robinetterie" => "gpec_16@gpec",
		"gmc.chaudronnerie" => "gpec_16@gpec",
		"gmc.tuyauterie_soudage" => "gpec_16@gpec",
		"gmc.automatisme" => "gpec_16@gpec",
		"gmc.electricite" => "gpec_16@gpec",
		"gmc.ventilation" => "gpec_16@gpec",
		"gmc.logistique" => "gpec_16@gpec",
		"gmc.securite" => "gpec_16@gpec",
		"gmc.soudage" => "gpec_16@gpec"
	);
}
else {
	$array_export_entities[0] = array(
...
if($datatoexport == 'gpec_matrice_competence') {
	$array_export_TypeFields[0] = array(
		...
		"g.status" => "Text",
		"eu.employeur" => "Text",
		"u.dateemployment" => "Date",
		"anciennete_optim" => "Numeric",
		"gmc.anciennete_metier" => "Numeric",
		"gmc.diplome" => "Text",
		"gmc.classification_pro" => "Text",
		"gmc.is_td" => "Numeric",
		"gmc.is_t" => "Numeric",
		"gmc.is_te" => "Numeric",
		"gmc.is_tc" => "Numeric",
		...
		"gmc.is_ic" => "Numeric",
		"gmc.is_ie" => "Numeric",
		"gmc.chef_projet" => "Numeric",
		"gmc.pilote_affaire" => "Numeric",
		"gmc.ingenieur_confirme" => "Numeric",
		"gmc.preparateur_charge_affaire" => "Numeric",
		"gmc.preparateur_methodes" => "Numeric",
		"gmc.charge_affaires_elec_auto" => "Numeric",
		"gmc.electricien" => "Numeric",
		"gmc.charge_affaires_mecanique" => "Numeric",
		"gmc.mecanicien" => "Numeric",
		"gmc.robinettier" => "Numeric",
		"gmc.pcr_operationnel" => "Numeric",
		"gmc.technicien_rp" => "Numeric",
		"gmc.charge_affaires_multi_specialites" => "Numeric",
		"gmc.mec_machine_tournante" => "Numeric",
		"gmc.robinetterie" => "Numeric",
		"gmc.chaudronnerie" => "Numeric",
		"gmc.tuyauterie_soudage" => "Numeric",
		"gmc.automatisme" => "Numeric",
		"gmc.electricite" => "Numeric",
		"gmc.ventilation" => "Numeric",
		"gmc.logistique" => "Numeric",
		"gmc.securite" => "Numeric",
		"gmc.soudage" => "Numeric"
	);
}
else {
...
if($datatoexport == 'gpec_matrice_competence') {
	$array_tablename[0] = array(
		...
		"u.lastname" => "llx_user",
		"ug.nom" => "llx_usergroup",
		"g.status" => "llx_gpec_gpec",
		"eu.employeur" => "llx_user_extrafields",
		"u.dateemployment" => "llx_user",
		"anciennete_optim" => "",
		"gmc.anciennete_metier" => "llx_gpec_matricecompetence",
		"gmc.diplome" => "llx_gpec_matricecompetence",
		"gmc.classification_pro" => "llx_gpec_matricecompetence",
		"gmc.is_td" => "llx_gpec_matricecompetence",
		"gmc.is_t" => "llx_gpec_matricecompetence",
		"gmc.is_te" => "llx_gpec_matricecompetence",
		"gmc.is_tc" => "llx_gpec_matricecompetence",
		"gmc.is_id" => "llx_gpec_matricecompetence",
		"gmc.is_i" => "llx_gpec_matricecompetence",
		"gmc.is_ic" => "llx_gpec_matricecompetence",
		"gmc.is_ie" => "llx_gpec_matricecompetence",
		"gmc.chef_projet" => "llx_gpec_matricecompetence",
		"gmc.pilote_affaire" => "llx_gpec_matricecompetence",
		"gmc.ingenieur_confirme" => "llx_gpec_matricecompetence",
		"gmc.preparateur_charge_affaire" => "llx_gpec_matricecompetence",
		"gmc.preparateur_methodes" => "llx_gpec_matricecompetence",
		"gmc.charge_affaires_elec_auto" => "llx_gpec_matricecompetence",
		"gmc.electricien" => "llx_gpec_matricecompetence",
		"gmc.charge_affaires_mecanique" => "llx_gpec_matricecompetence",
		"gmc.mecanicien" => "llx_gpec_matricecompetence",
		"gmc.robinettier" => "llx_gpec_matricecompetence",
		"gmc.pcr_operationnel" => "llx_gpec_matricecompetence",
		"gmc.technicien_rp" => "llx_gpec_matricecompetence",
		"gmc.charge_affaires_multi_specialites" => "llx_gpec_matricecompetence",
		"gmc.mec_machine_tournante" => "llx_gpec_matricecompetence",
		"gmc.robinetterie" => "llx_gpec_matricecompetence",
		"gmc.chaudronnerie" => "llx_gpec_matricecompetence",
		"gmc.tuyauterie_soudage" => "llx_gpec_matricecompetence",
		"gmc.automatisme" => "llx_gpec_matricecompetence",
		"gmc.electricite" => "llx_gpec_matricecompetence",
		"gmc.ventilation" => "llx_gpec_matricecompetence",
		"gmc.logistique" => "llx_gpec_matricecompetence",
		"gmc.securite" => "llx_gpec_matricecompetence",
		"gmc.soudage" => "llx_gpec_matricecompetence"
	);
}
else {
	$array_tablename[0] = array(
...
$array_export_module['name'] = $langs->transnoentitiesnoconv("ModuleGPECName");

if($datatoexport == 'gpec_competence_domaine') {
	$array_export_label[0] = "Compétences par domaines des Utilisateurs";
}
elseif($datatoexport == 'gpec_competence_transverse') {
	$array_export_label[0] = "Compétences transverses des Utilisateurs";
}
elseif($datatoexport == 'gpec_matrice_competence') {
	$array_export_label[0] = "Matrice des compétences des Utilisateurs";
}
else {
	$array_export_label[0] = "Compétences par domaines des Utilisateurs";
	$array_export_label[1] = "Compétences transverses des Utilisateurs";
	$array_export_label[2] = "Matrice des compétences des Utilisateurs";
}


$array_export_icon[0] = "gpec_16@gpec";
...
if ($step == 1 || !$datatoexport) {
	llxHeader('', $langs->trans("Export GPEC"));

	$h = 0;

	$head[$h][0] = DOL_URL_ROOT.'/custom/gpec/export.php?step=1';
	...
	if (count($array_export_module)) {
		foreach ($array_export_label as $key => $value) {
			...
			if ($user->rights->gpec->gpec->export) {
				print '<a href="'.DOL_URL_ROOT.'/custom/gpec/export.php?step=2&export_code='.$key.'">'.img_picto($langs->trans("NewExport"), 'next', 'class="fa-15"').'</a>';
			} else {
...
if ($step == 2 && $datatoexport) {
	...
	$head[$h][0] = DOL_URL_ROOT.'/custom/gpec/export.php?step=2&datatoexport='.$datatoexport;
	...
	print '<td>';
	print $langs->transnoentitiesnoconv("ModuleGPECName");
	print '</td></tr>';

	// Lot de donnees a exporter
	print '<tr><td>'.$langs->trans("DatasetToExport").'</td>';
	print '<td>';
	print img_object("GPEC", "gpec_16@gpec").' ';
...
if ($step == 3 && $datatoexport) {
	if (count($array_selected) < 1) {      // This occurs when going back to page after sessecion expired
		// Switch to step 2
		header("Location: ".DOL_URL_ROOT.'/custom/gpec/export.php?step=2&datatoexport='.$datatoexport);
		exit;
	}
	...
	$head[$h][0] = DOL_URL_ROOT.'/custom/gpec/export.php?step=3&datatoexport='.$datatoexport;
...
if ($step == 4 && $datatoexport) {
	if (count($array_selected) < 1) {     // This occurs when going back to page after sessecion expired
		// Switch to step 3
		header("Location: ".DOL_URL_ROOT.'/custom/gpec/export.php?step=3&datatoexport='.$datatoexport);
		exit;
	}
	...
	$head[$h][0] = DOL_URL_ROOT.'/custom/gpec/export.php?step=4&datatoexport='.$datatoexport;
...
if ($step == 5 && $datatoexport) {
	if (count($array_selected) < 1) {      // This occurs when going back to page after sessecion expired
		// Switch to step 4
		header("Location: ".DOL_URL_ROOT.'/custom/gpec/export.php?step=4&datatoexport='.$datatoexport);
		exit;
	}
	...
	$head[$h][0] = DOL_URL_ROOT.'/custom/gpec/export.php?step=5&datatoexport='.$datatoexport;
