...
/**
 *    \file       htdocs/custom/gpeccustom/skill_list.php
 *    \ingroup    hrm
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/custom/gpeccustom/skill_card.php', 1).'?id='.$id);
	exit;
}
...
//     setEventMessages($langs->trans("SkillsValidated", $nbValidated), null, 'mesgs');
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', DOL_URL_ROOT.'/custom/gpeccustom/skill_card.php?action=create', '', $permissiontoadd);
