...
function jobPrepareHead($object)
{
	...
	$head[$h][0] = DOL_URL_ROOT."/custom/gpeccustom/job_card.php?id=".$object->id;
	$head[$h][1] = $langs->trans("JobProfile");
	$head[$h][2] = 'job_card';
	$h++;

	$head[$h][0] = DOL_URL_ROOT."/custom/gpeccustom/skill_tab.php?id=".$object->id.'&objecttype=job';
	...
	$head[$h][0] = DOL_URL_ROOT."/custom/gpeccustom/position.php?id=".$object->id;
	...
	if (isset($object->fields['note_public']) || isset($object->fields['note_private'])) {
		...
		$head[$h][0] = dol_buildpath('/custom/gpeccustom/job_note.php', 1).'?id='.$object->id;
	...
	$upload_dir = $conf->gpeccustom->dir_output."/job/".dol_sanitizeFileName($object->label);
	$nbFiles = count(dol_dir_list($upload_dir, 'files', 0, '', '(\.meta|_preview.*\.png)$'));
	$nbLinks = Link::count($db, $object->element, $object->id);
	$head[$h][0] = DOL_URL_ROOT."/custom/gpeccustom/job_document.php?id=".$object->id;
	...
	$head[$h][0] = DOL_URL_ROOT."/custom/gpeccustom/job_agenda.php?id=".$object->id;
