...
function positionCardPrepareHead($object)
{
	...
	$head[$h][0] = dol_buildpath("/gpeccustom/position_card.php", 1).'?id='.$object->id;
	...
	if (isset($object->fields['note_public']) || isset($object->fields['note_private'])) {
		...
		$head[$h][0] = dol_buildpath('/gpeccustom/position_note.php', 1).'?id='.$object->id;
	...
	$head[$h][0] = dol_buildpath("/gpeccustom/position_document.php", 1).'?id='.$object->id;
	...
	$head[$h][0] = dol_buildpath("/gpeccustom/position_agenda.php", 1).'?id='.$object->id;
