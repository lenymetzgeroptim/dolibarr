 ...
 */
function pdf_getInstanceCustom($object, $format = '', $metric = 'mm', $pagetype = 'P')
{
	global $conf;
	...
	require_once DOL_DOCUMENT_ROOT.'/custom/gpeccustom/core/modules/gpeccustom/doc/tcpdf_custom.php';
