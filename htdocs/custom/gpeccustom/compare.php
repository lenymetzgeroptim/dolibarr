...
require_once DOL_DOCUMENT_ROOT . '/custom/gpeccustom/lib/hrm.lib.php';
...
// Permissions
$permissiontoread = $user->rights->gpeccustom->evaluation->readall || $user->rights->gpeccustom->compare_advance->read;
$permissiontoadd = 0;
