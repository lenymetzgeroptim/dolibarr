...
$permissiontoadd = $user->rights->gpeccustom->gpeccustom->write; // Used by the include of actions_addupdatedelete.inc.php
...
if ($object->id > 0) {
	...
	// Object card
	// ------------------------------------------------------------
	$linkback = '<a href="'.dol_buildpath('/custom/gpeccustom/position_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
