...
/**
 * \file    gpeccustom/js/gpeccustom.js.php
 * \ingroup gpeccustom
 * \brief   JavaScript file for module Gpeccustom.
 */
...
/* Javascript library of module Gpeccustom */
function fetchJobSkills() {
    $.ajax({
        ...
        success: function(data) {
			...
			console.log('Données des emplois et des compétences reçus :', data);
