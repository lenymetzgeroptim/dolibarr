...
class Evaluationline extends CommonObject
{
	...
	public $fields=array(
		...
		'fk_skill' => array('type'=>'integer:Skill:custom/gpeccustom/class/skill.class.php:1', 'label'=>'Skill', 'enabled'=>'1', 'position'=>3, 'notnull'=>1, 'visible'=>1, 'index'=>1,),
		'fk_evaluation' => array('type'=>'integer:Evaluation:custom/gpeccustom/class/evaluation.class.php:1', 'label'=>'Evaluation', 'enabled'=>'1', 'position'=>3, 'notnull'=>1, 'visible'=>1, 'index'=>1,),
	...
	public function validate($user, $notrigger = 0)
	{
		...
		if (!$error) {
			...
			if (preg_match('/^[\(]?PROV/i', $this->ref)) {
				...
				$dirsource = $conf->gpeccustom->dir_output.'/evaluationline/'.$oldref;
				$dirdest = $conf->gpeccustom->dir_output.'/evaluationline/'.$newref;
				if (!$error && file_exists($dirsource)) {
					...
					if (@rename($dirsource, $dirdest)) {
						...
						$listoffiles = dol_dir_list($conf->gpeccustom->dir_output.'/evaluationline/'.$newref, 'files', 1, '^'.preg_quote($oldref, '/'));
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$url = dol_buildpath('/gpeccustom/evaluationdet_card.php', 1).'?id='.$this->id;
