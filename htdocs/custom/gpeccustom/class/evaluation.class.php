...
require_once DOL_DOCUMENT_ROOT . '/custom/gpeccustom/class/evaluationline.class.php';
...
class Evaluation extends CommonObject
{
	...
	public $fields=array(
		...
		'fk_job' => array('type'=>'integer:Job:/custom/gpeccustom/class/job.class.php', 'label'=>'JobProfile', 'enabled'=>'1', 'position'=>505, 'notnull'=>1, 'visible'=>1,),
	);
	public $rowid;
	public $ref;
	public $label;
	...
	//  */
	protected $childtablesoncascade = array('@Evaluationline:custom/gpeccustom/class/evaluationline.class.php:fk_evaluation');
	...
	public function __construct(DoliDB $db)
	{
		...
		if (!$user->hasRight('gpeccustom', 'evaluation', 'readall')) {
	...
	public function validate($user, $notrigger = 0)
	{
		...
		if (!$error) {
			...
			if (preg_match('/^[\(]?PROV/i', $this->ref)) {
				...
				$dirsource = $conf->gpeccustom->dir_output.'/evaluation/'.$oldref;
				$dirdest = $conf->gpeccustom->dir_output.'/evaluation/'.$newref;
				if (!$error && file_exists($dirsource)) {
					...
					if (@rename($dirsource, $dirdest)) {
						...
						$listoffiles = dol_dir_list($conf->gpeccustom->dir_output.'/evaluation/'.$newref, 'files', 1, '^'.preg_quote($oldref, '/'));
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$url = dol_buildpath('/gpeccustom/evaluation_card.php', 1).'?id='.$this->id;
