...
/**
 * \file        htdocs/modulebuilder/template/class/jobfield.class.php
 * \ingroup     mymodule
 ...
 * Class for MyObject
 */
class JobField extends CommonObject
{
	/**
	 ...
	 */
	public $element = 'jobfield';

	/**
	 * @var string Name of table without prefix where object is stored. This is also the key used for extrafields management.
	 */
	public $table_element = 'gpeccustom_jobfield';
	...
	public $fields = array(
		...
		'label'         => array('type'=>'varchar(255)', 'label'=>'Nom', 'enabled'=>1, 'visible'=>1, 'position'=>30, 'searchall'=>1, 'css'=>'minwidth300', 'cssview'=>'wordbreak', 'help'=>'Help text', 'showoncombobox'=>2, 'validate'=>1, 'alwayseditable'=>1),
		...
		'status'        => array('type'=>'integer', 'label'=>'Status', 'enabled'=>1, 'visible'=>1, 'notnull'=> 1, 'default'=>1, 'index'=>1, 'position'=>2000, 'arrayofkeyval'=>array(1=>'Validated', 9=>'Canceled'), 'validate'=>1),
	);
	...
	//  */
	// public $table_element_line = 'gpeccustom_jobfieldline';
