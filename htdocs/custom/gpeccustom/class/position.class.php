...
class Position extends CommonObject
{
	...
	public $fields=array(
		...
		'fk_job' => array('type'=>'integer:Job:gpeccustom/class/job.class.php', 'label'=>'JobProfile', 'enabled'=>'1', 'position'=>56, 'notnull'=>1, 'visible'=>1,),
		// 'rankorder' => array('type'=>'integer', 'label'=>'Level', 'enabled'=>'1', 'position'=>58, 'notnull'=>1, 'visible'=>-2,),
		// 'required_rank' => array('type'=>'integer', 'label'=>'RequiredLevel', 'enabled'=>'1', 'position'=>60, 'notnull'=>1, 'visible'=>-2,),
		// 'fk_skill' => array('type'=>'integer:Skill:gpeccustom/class/skill.class.php', 'label'=>'SkillProfile', 'enabled'=>'1', 'position'=>60, 'notnull'=>1, 'visible'=>1,),
	...
	public function validate($user, $notrigger = 0)
	{
		...
		if (!$error) {
			...
			if (preg_match('/^[\(]?PROV/i', $this->ref)) {
				...
				$dirsource = $conf->gpeccustom->dir_output . '/position/' . $oldref;
				$dirdest = $conf->gpeccustom->dir_output . '/position/' . $newref;
				if (!$error && file_exists($dirsource)) {
					...
					if (@rename($dirsource, $dirdest)) {
						...
						$listoffiles = dol_dir_list($conf->gpeccustom->dir_output . '/position/' . $newref, 'files', 1, '^' . preg_quote($oldref, '/'));
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$url = dol_buildpath('/custom/gpeccustom/position_card.php', 1) . '?id=' . $this->id;
