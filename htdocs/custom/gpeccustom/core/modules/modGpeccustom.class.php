...
class modGpeccustom extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->description = "Customisation du module GRH pour la partie GPEC";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "Customisation du module GRH-Gpec pour introduire la génération des cv, le motuer de recherche, les indicateurs, ...";
		...
		*/
		...
		// 	'position'=>10+$r,
		// 	'enabled'=>'isModEnabled("hrm")', // Define condition to show or hide menu entry. Use 'isModEnabled("workload")' if entry must be visible if module is enabled.
		...
		/* LEFTMENU GESTION DES COMPéTENCES */
		// $this->menu[$r++]=array(
		// 	'fk_menu' =>'fk_mainmenu=hrm,fk_leftmenu=hrm_sm',
		// 	 'type' =>'left',
		// 	 'titre' =>'Indicateurs',
		// 	 'mainmenu' =>'hrm',
		// 	 'leftmenu' =>'hrm_sm_tb',
	...
	//    );
	//    $this->menu[$r++]=array(
	// 	'fk_menu' =>'fk_mainmenu=hrm,fk_leftmenu=hrm_sm_list',
	// 	'type' =>'left',
	// 	'titre' =>'CVTec 2',
	// 	'mainmenu' =>'hrm',
	// 	'leftmenu' =>'hrm_cvtec_list',
	// 	'url' =>'/gpeccustom/cvtec_report.php',
	// 	'langs' =>'gpeccustom@gpeccustom',
	// 	'position' =>1000 + $r,
	// 	'enabled' =>'isModEnabled("gpeccustom")',
	// 	'perms' =>'1',
	...
	// 	'user' =>2,
  	// 	 );
		...
		$this->export_icon[$r]='myobject@gpeccustom';
