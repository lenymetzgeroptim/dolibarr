...
class pdf_standard_cvtec extends ModelePDFCVTec
{
    ...
    //     // Logo
    //     $image_file = K_PATH_IMAGES.'logo_example.jpg'; // Remplacez par le chemin de votre logo
    //     $this->Image($image_file, 10, 10, 20, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
    //     // Titre
    //     $this->SetFont('helvetica', 'B', 12);
    //     $this->Cell(0, 15, 'CV - ' . $this->getHeaderData()['title'], 0, false, 'C', 0, '', 0, false, 'M', 'M');
    // }

    // Pied de page
    public function Footer() {
        // Position au bas de la page
        $this->SetY(-15);
		...
		*/
		...
		if ($conf->gpeccustom->dir_output.'/cvtec') {
			...
			if (file_exists($dir)) {
				...
				// $top_shift = $this->Header($pdf, $pagenb, $pages, $outputlangs);
				...
				*/
				...
				if(file_exists($_SERVER['DOCUMENT_ROOT'] . "/img/".$object->id."/".$object->id.".png")) {
				 $img = $_SERVER['DOCUMENT_ROOT'] . "/img/".$object->id."/".$object->id.".png";
				}
				// // //the img path is used in pdf 
				// $pdf->Image('@' . $img, 55, 19, '', '', 'PNG', '', 'T', false, 50, '', false, false, 0, false, false, false);
				...
				$pdf->SetXY($this->marge_gauche, $tab_top + 2);
					...
					// $html .= $this->_blocUsersPosition($img);
					...
					// $pdf->Cell(30, 20,  $pdf->writeHTML($html), 0, 1, 'L');
					// $pdf->Cell(0, 10, 'This is the first page of group 2', 0, 1, 'L');
					// $pdf->AddPage();
					// $pdf->Cell(0, 10, $pdf->writeHTML($html), 0, 1, 'L');
					// $pdf->AddPage();
					...
					// $html .= $object->getskillJobAvgGraph($arr_skill_jobs, $filter_fk_user, $date_start, $date_end);

					if(file_exists($_SERVER['DOCUMENT_ROOT'] . "/img/".$object->id."/".$object->id.".png")) {
						// $img = file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/img/".$object->id."/".$object->id.".png");
						// // //the img path is used in pdf 
						// $pdf->Image('@' . $img, 55, 19, '', '', 'PNG', '', 'T', false, 2000, '', false, false, 0, false, false, false);
					}
	...
	//get all user's affected jobs, with descriptions and period position date
	/**
	 * 
	 * @param object cvtec object to call function 
	 * 
	 * @return string html data
	 */
	public function _blocUsersPosition($img)
	{
		
		$html = '<br><br>'.
				'<div class="table_component" role="region" tabindex="0" style="overflow: auto;width: 100%;line-height: 120%;">'.
							'<table style="border-right-color:#ffffff;border-left-color:#ffffff;height: 100%;width: 100%;table-layout: fixed;border-collapse: collapse;border-spacing: 0px;text-align: center;">'.
								// '<caption style="caption-side: top;text-align: left;">Table 1</caption>'.
								...
								'<tbody>
									...
									<tr>
									<td width="4%" style="background-color: #2e406f;color: #fff;padding: 5px;line-height: 150%; font-size:16px;font-weight:900;"><span> OPT IM  </span>&nbsp;<span>INDUSTR I ES</span></td>
										<td width="96%" style="border-right-color:#dededf;color: #000000;background-color: #f0f2f1;">
									
										<img style="display: inline-block;float: none;vertical-align: bottom;max-width: 100%;max-height: 100%;position: relative;" class="avatar fr-rounded fr-fic fr-dii" src="'.$img.'" loading="">
		...
		$html .= '<div class="ResumeModal_resumeContainer__Rl6Tp" style="padding: 16px;height:30px;background-color: #f0f2f1;">';
		$html .= '<div class="ResumeCanvas_wrapper__Z6QuM ResumeCanvas_wrapperPaper__P_FD_" style="box-shadow: 0 2px 6px rgba(26,31,28,.08);background-color: #fff;">';
		$html .= '<div class="cr markarea tech" style="font-family: Roboto,Noto Sans TC,Noto Sans SC,Noto Sans KR,Noto Sans JP,Noto Sans,PingFang TC,Microsoft JhengHei,PMingLiU,sans-serif;padding-right: 10.02px;padding-left: 10.02px;word-wrap: break-word;">';
		$html .= '<div class="row general with-background general-profile-2 with-background-profile-2" style="background-color: #2e406f;padding-top: 50.1px !important;display: flex;margin-right: -10.02px;margin-left: -10.02px;">';
		$html .= '<div class="col-sm-4" style="padding-right: 10.02px;padding-left: 10.02px;width: 33.33333333%;float: left;display: flex;">';
		$html .= '<p class="avatar-wrapper" style="font-size: 16.7px;line-height: 1.5;">';
		$html .= '</p><span class="fr-icon-space-wrapper">&nbsp;<h1></h1><h4>Product Manager</h4></span>';
		$html .= '<p>';
		$html .= '</span> Paris, France (Remote)</p>';
		$html .= '<div class="col-sm-8" style="padding-right: 10.02px;padding-left: 10.02px;width: 66.66666667%;">';
		$html .= '<p style="text-align: center;padding:50px;">After 10 years in web and mobile development, I decided to challenge myself by working as a Product manager. To improve my skills I take profit of the mondial pandemic to study online and being graduated in a Marketing Master degree in parallel of my job.<br>I am working in French biggest TV channel Since 2017, on high traffic website and mobile app.<br>I’m looking for a full-time remote opportunity, and I dream to relocate in Taiwan.</p><p><a href="https://www.linkedin.com/in/maximeoriol/" target="_blank" rel="nofollow noopener" data-linkz-ai=""><span class="fr-myicon fr-deletable black fr-myicon-img" style="background: url(https://spa-assets.cakeresume.com/assets/editor/icons//black/social_media/linkedin.svg);"><span class="fr-icon-space-wrapper">&nbsp;</span></span></a>&nbsp; <a href="https://stackoverflow.com/users/2678558/maxime" target="_blank" rel="nofollow noopener" data-linkz-ai=""><span class="fr-myicon fr-deletable black fr-myicon-img" style="background: url(https://spa-assets.cakeresume.com/assets/editor/icons//black/social_media/stack_overflow.svg);"><span class="fr-icon-space-wrapper">&nbsp;</span></span></a>&nbsp;</p></div></div><div class="row heading heading-work-experience-6"><div class="col-sm-12"><h2>Work Experience</h2></div></div><div class="row repeater repeater-work-experience-6"><div class="col-sm-11"><h3>Product Manager<br><span class="theme-main-color" style="font-size: 18.37px;">TF1 – Product manager (FR)</span></h3><p><span style="color: #888;">July 2017 - Present</span></p><p>• Working in an Agile context<br>• Identify next features to implement or evolve to improve our product<br>• Prioritise subjects regarding  manager\'s requests, business value and user value<br>• Working with KPI for weekly and monthly reports.</p></div><div class="col-sm-1"><img class="logo fr-rounded" src="https://spa-assets.cakeresume.com/assets/f17124912b75a710bc32f6474605ed89.png" loading=""></div></div><div class="row repeater repeater-work-experience-6"><div class="col-sm-11"><h3>Freelancer – iOS developer Team manager<br><span class="theme-main-color" style="font-size: 18.37px;">Mapeeks – Own company (FR)</span></h3><p><span style="color: #888;">January 2015 - July 2017</span></p><p>• Manage a company with 3 employees<br>• Lead developer<br>• R&amp;D in mobile advertising<br>• Mobile developer</p></div><div class="col-sm-1"><img class="logo fr-rounded" src="https://spa-assets.cakeresume.com/assets/f17124912b75a710bc32f6474605ed89.png" loading=""></div></div><div class="row repeater repeater-work-experience-6 repeater-end"><div class="col-sm-11"><h3>Mobile developer<br><span class="theme-main-color" style="font-size: 18.37px;">Agencies, Paris (FR)</span></h3><p><span style="color: #888;">September 2009 - January 2015</span></p><p>• Android developer<br>• iOS developer</p></div><div class="col-sm-1"><img class="logo fr-rounded" src="https://spa-assets.cakeresume.com/assets/f17124912b75a710bc32f6474605ed89.png" loading=""></div></div><div class="row heading heading-education-2"><div class="col-sm-12"><h2>Education</h2></div></div><div class="row repeater bottom-border repeater-education-2 bottom-border-education-2"><div class="col-sm-12"><p><span style="color: #888;">2020 - 2021</span></p><h3>Master’s degree, Management and Business Strategy</h3><h4>Marketing strategy</h4></div></div><div class="row repeater bottom-border repeater-education-2 bottom-border-education-2"><div class="col-sm-12"><p><span style="color: #888;">2007 - 2009</span></p><h3>Bachelor’s degree in Networks and communication</h3><h4>Communication</h4></div></div><div class="row repeater bottom-border repeater-education-2 bottom-border-education-2 repeater-end"><div class="col-sm-12"><p><span style="color: #888;">2004 - 2007</span></p><h3>Baccalaureate, Electronic</h3><h4>Electronic</h4></div></div><div class="row heading with-background heading-skills-2 with-background-skills-2"><div class="col-sm-12"><h2>Skills</h2></div></div><div class="row repeater with-background repeater-skills-2 with-background-skills-2 repeater-end"><div class="col-sm-4"><h3>Development</h3><hr><ul><li>iOS (Objective-C, Swift)</li><li>Android (Java)</li><li>Web (HTML, PHP, ReactJS, NodeJS...)</li></ul></div><div class="col-sm-4"><h3>Team Management</h3><hr><ul><li>KPI Strategy</li><li>Agile methodology</li><li>Scrum</li><li>Jira, &nbsp;Confluence</li></ul></div><div class="col-sm-4"><h3>Language</h3><hr><ul><li>French (Native language)</li><li>English (Professional)</li><li>Chinese (Intermediate)</li></ul></div></div></div>';
		$html .= '</div>';
		$html .= '</div>';
		return $html;
	}
	...
	public function _blocTableExperience($object, &$pdf, $outputlangs, $outputlangsbis)
	{
		global $langs;
		$verticalTitle = strtoupper($langs->trans('experi ence'));
		...
		// Définir les marges d'en-tête et de pied de page
		...
		$html = '<br><br>'.
				'<div class="table_component" role="region" tabindex="0" style="overflow: auto;width: 100%;line-height: 120%;">'.
							'<table style="border-right-color:#ffffff;border-left-color:#ffffff;height: 100%;width: 100%;table-layout: fixed;border-collapse: collapse;border-spacing: 0px;">'.
								// '<caption style="caption-side: top;text-align: left;">Table 1</caption>'.
								
								'<tbody>
									
									<tr>';
									// $pdf->MultiCell(5, 5, '[LEFT] '.$verticalTitle, 1, 'L', 0, 1, '', '', true);
									// $pdf->MultiCell(55, 5, $verticalTitle, 1, 'J', 1, 2, 125, 210, true);
									$html .= '<td width="4%" style="background-color: #2e406f;color: #fff;line-height: 180%; font-size:16px;font-weight:900;text-align: center;"><td  width="50%"> &nbsp;</td><span>'.$verticalTitle.'</span><td  width="50%"> &nbsp;</td></td>';
									// $pdf->Cell(0, 0, 'TEST CELL STRETCH: force spacing', 1, 1, 'C', 0, '', 4);
									$html .= '<td width="96%">';
									// $html .= '<div class="row heading heading-work-experience-6">';
											...
											foreach($object->getLastUserJob($object->fk_user) as $key => $values) {
												foreach($values as $date_start => $vals) {
													foreach($vals as $date_end => $value) {
														...
														$html .= '<h1> Pour le test --- '.$object->fk_user.'</h1>';
														$html .= '<div class="row repeater repeater-work-experience-6"><div class="col-sm-11">';
														$html .= '<h3>  '.$label.'</h3>';
														// $html .= '<span class="theme-main-color" style="font-size: 18.37px;">OPTIM Industries – '.$label.'</span></h3>';
														$html .= '<p><span style="color: #888;">  '.dol_print_date($date_start, '%B %Y').''.$end_date.'</span></p>';
														
														$html .= '<div><p><span style="text-align:justify;">'.nl2br($description).'</span></p></div>';
											
														// $html .= '</div><div class="col-sm-1"><img class="logo fr-rounded" src="https://spa-assets.cakeresume.com/assets/f17124912b75a710bc32f6474605ed89.png" loading=""></div></div>';
														$html .= '</div>';
														$html .= '</div>';
														...
														$html .= '</div>';
														$html .= '</div>';
														// $line = $pdf->getNumLines($html);
												
														// $totalLigneTraitee = 0;
														// 	$paquetTaille = 21;
														// 	// foreach($lines as $line) {
														// 	 	$totalLigneTraitee += $line;
														// 	 	if($totalLigneTraitee >= $paquetTaille) {
														// 			var_dump($totalLigneTraitee);
														// 			$this->_pagefoot($pdf, $object, $outputlangs);
														// 			// $this->_pagehead($pdf, $object, 0, $outputlangs, $outputlangsbis);
														// 		}
														// 		if($totalLigneTraitee % 21 != 0) {
														// 			$ligneRestante = $totalLigneTraitee%40;
														// 			$this->_pagefoot($pdf, $object, $outputlangs);
														// 			$html .= 'test';
														// 			// $this->_pagehead($pdf, $object, 0, $outputlangs, $outputlangsbis);
														// 		}
		...
		// $html .= '<div class="col-sm-8" style="padding-right: 10.02px;padding-left: 10.02px;width: 66.66666667%;">';
		// $html .= '</div><div class="row heading heading-work-experience-6">';
		// $html .= '<div class="col-sm-12"><h2>Experience</h2></div></div>';
		// $html .= '<div class="row repeater repeater-work-experience-6"><div class="col-sm-11">';
		// $html .= '<h3>'.$label.'<br>';
		// $html .= '<span class="theme-main-color" style="font-size: 18.37px;">OPTIM Industries – '.$label.'</span></h3>';
		// $html .= '<p><span style="color: #888;">'.dol_print_date($date_start, '%B %Y').''.$end_date.'</span></p>';
		// $html .= '<p>'.nl2br($description).'<br>';
	
		// $html .= '</p></div><div class="col-sm-1"><img class="logo fr-rounded" src="https://spa-assets.cakeresume.com/assets/f17124912b75a710bc32f6474605ed89.png" loading=""></div></div>';
		// $html .= '</div>';
		// $html .= '</div>';
		// $html .= '<div class="row heading heading-education-2"><div class="col-sm-12"><h2>Education</h2></div></div><div class="row repeater bottom-border repeater-education-2 bottom-border-education-2"><div class="col-sm-12"><p><span style="color: #888;">2020 - 2021</span></p><h3>Master’s degree, Management and Business Strategy</h3><h4>Marketing strategy</h4></div></div><div class="row repeater bottom-border repeater-education-2 bottom-border-education-2"><div class="col-sm-12"><p><span style="color: #888;">2007 - 2009</span></p><h3>Bachelor’s degree in Networks and communication</h3><h4>Communication</h4></div></div><div class="row repeater bottom-border repeater-education-2 bottom-border-education-2 repeater-end"><div class="col-sm-12"><p><span style="color: #888;">2004 - 2007</span></p><h3>Baccalaureate, Electronic</h3><h4>Electronic</h4></div></div><div class="row heading with-background heading-skills-2 with-background-skills-2"><div class="col-sm-12"><h2>Skills</h2></div></div><div class="row repeater with-background repeater-skills-2 with-background-skills-2 repeater-end"><div class="col-sm-4"><h3>Development</h3><hr><ul><li>iOS (Objective-C, Swift)</li><li>Android (Java)</li><li>Web (HTML, PHP, ReactJS, NodeJS...)</li></ul></div><div class="col-sm-4"><h3>Team Management</h3><hr><ul><li>KPI Strategy</li><li>Agile methodology</li><li>Scrum</li><li>Jira, &nbsp;Confluence</li></ul></div><div class="col-sm-4"><h3>Language</h3><hr><ul><li>French (Native language)</li><li>English (Professional)</li><li>Chinese (Intermediate)</li></ul></div></div></div>';
		// $html .= '</div>';
		...
		// 	EOD;
			...
			// $pdf->SetFillColor(71,13,98);
			// $pdf->PieSector($xc, $yc, $r, 20, 70, 'FD', false, 0, 2);

			// $pdf->SetFillColor(2,96,131);
			// $pdf->PieSector($xc, $yc, $r, 70, 220, 'FD', false, 0, 2);

			// $pdf->SetFillColor(123,168,26);
			// $pdf->PieSector($xc, $yc, $r, 220, 20, 'FD', false, 0, 2);

			// write labels
			// $pdf->SetTextColor(255,255,255);
				// $pdf->Text(90, 55, 'BLUE');
				// $pdf->Text(100, 85, 'GREEN');
				// $pdf->Text(120, 65, 'RED');
	...
	//get all user's evalauted jobs, with skills note and dates
	/**
	 * 
	 * @param object cvtec object to call function 
	 * 
	 ...
	 * 
	 */
	public function _blocUsersEvalSkills($object)
	{
