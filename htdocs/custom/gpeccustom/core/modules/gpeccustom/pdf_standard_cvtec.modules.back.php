		...
		if ($conf->gpeccustom->dir_output.'/cvtec') {
			...
			if (file_exists($dir)) {
				...
				*/
				...
				// var_dump(file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/img/".$object->id."/".$object->id.".png"));	
...
if(file_exists($_SERVER['DOCUMENT_ROOT'] . "/img/".$object->id."/".$object->id.".png")) {
	...
	$pdf->Image('@' . $img, 55, 19, '', '', 'PNG', '', 'T', false, 200, '', false, false, 0, false, false, false);
}
	 ...
	 */
	public function _blocUsersPosition($object)
	{
