...
// include DOL_DOCUMENT_ROOT.'/hrm/class/job.class.php';
...
$object->fields = array(
	...
	'fk_job' => 
		array(
		'type' => 'integer:Job:hrm/class/job.class.php',
		'label' => 'Emploi',
		'enabled' => '1',
		'position' => 10,
		'notnull' => 1,
...
print '<tr><td>Salariés en poste non encore évalués</td></tr>';
...
print '<div class="div-table-responsive">'; // You can use div-table-responsive-no-min if you dont need reserved height for your table
print '<table class="tagtable nobottomiftotal liste'.($moreforfilter ? " listwithfilterbefore" : "").'">'."\n";
print '<tr><td>Salariés non affecté à un emploi</td></tr>';
