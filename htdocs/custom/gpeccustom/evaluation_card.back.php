...
// Permissions
$permissiontoread = $user->rights->gpeccustom->evaluation->readall;
	...
	$(document).ready(function() {
	  $("#btn_valid").click(function(){
		 ...
		 $.ajax({
             ...
             window.location.href = "'.dol_buildpath('/gpeccustom/evaluation_card.php', 1).'?id='.$id.'&action=validate&token='.newToken().'";
             return false;
		 });
