...
$diroutputmassaction = $conf->gpeccutom->dir_output.'/temp/massgeneration/'.$user->id;
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->gpeccustom->multidir_output[$object->entity ? $object->entity : $conf->entity]."/skill/".get_exdir(0, 0, 0, 1, $object);
}

// Permissions
$permissiontoread = $user->rights->gpeccustom->gpeccustom->read;
$permissiontoadd  = $user->rights->gpeccustom->gpeccustom->write; // Used by the include of actions_addupdatedelete.inc.php and actions_linkedfiles.inc.php
