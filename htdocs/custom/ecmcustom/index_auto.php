...
$mode = 'noajax';
$url = DOL_URL_ROOT.'/custom/ecmcustom/index_auto.php';
include_once DOL_DOCUMENT_ROOT.'/custom/ecmcustom/ajax/ajaxdirpreview.php';
...
if (!empty($conf->use_javascript_ajax) && empty($conf->global->MAIN_ECM_DISABLE_JS)) {
	include DOL_DOCUMENT_ROOT.'/custom/ecmcustom/tpl/enablefiletreeajax.tpl.php';
}
