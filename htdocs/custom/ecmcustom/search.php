...
$result = restrictedArea_custom($user, 'ecmcustom', '');

// Load permissions
$user->getrights('ecmcustom');
...
$upload_dir = $conf->ecmcustom->dir_output.'/'.$section;
...
print '<form method="post" action="'.DOL_URL_ROOT.'/custom/ecmcustom/search.php">';
...
$formfile->list_of_documents($filearray, '', 'ecmcustom', $param, 1, $relativepath, $user->rights->ecmcustom->delete, 1, $textifempty);
