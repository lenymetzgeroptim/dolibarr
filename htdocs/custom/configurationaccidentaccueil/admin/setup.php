...
/**
 * \file    configurationaccidentaccueil/admin/setup.php
 * \ingroup configurationaccidentaccueil
 * \brief   ConfigurationAccidentAccueil setup page.
 */
...
require_once '../lib/configurationaccidentaccueil.lib.php';
...
$arrayofparameters = array(
	//'CONFIGURATIONACCIDENTACCUEIL_MYPARAM1'=>array('type'=>'string', 'css'=>'minwidth500' ,'enabled'=>1),
	//'CONFIGURATIONACCIDENTACCUEIL_MYPARAM2'=>array('type'=>'textarea','enabled'=>1),
	//'CONFIGURATIONACCIDENTACCUEIL_MYPARAM3'=>array('type'=>'category:'.Categorie::TYPE_CUSTOMER, 'enabled'=>1),
	//'CONFIGURATIONACCIDENTACCUEIL_MYPARAM4'=>array('type'=>'emailtemplate:thirdparty', 'enabled'=>1),
	//'CONFIGURATIONACCIDENTACCUEIL_MYPARAM5'=>array('type'=>'yesno', 'enabled'=>1),
	//'CONFIGURATIONACCIDENTACCUEIL_MYPARAM5'=>array('type'=>'thirdparty_type', 'enabled'=>1),
	//'CONFIGURATIONACCIDENTACCUEIL_MYPARAM6'=>array('type'=>'securekey', 'enabled'=>1),
	//'CONFIGURATIONACCIDENTACCUEIL_MYPARAM7'=>array('type'=>'product', 'enabled'=>1),
);
...
$help_url = '';
$page_name = "ConfigurationAccidentAccueilSetup";
...
$head = configurationaccidentaccueilAdminPrepareHead();
print dol_get_fiche_head($head, 'settings', $langs->trans($page_name), -1, "configurationaccidentaccueil@configurationaccidentaccueil");

// Setup page goes here
echo '<span class="opacitymedium">'.$langs->trans("ConfigurationAccidentAccueilSetupPage").'</span><br><br>';
