...
class modConfigurationAccidentAccueil extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->tabs = array('data'=>'user:+conf_accident_accueil:Configuration QSE Accueil::$user->rights->configurationaccidentaccueil->modify&&$user->id==GETPOST("id","integer"):/configurationaccidentaccueil/setup.php?id=__ID__');
		// Example:
