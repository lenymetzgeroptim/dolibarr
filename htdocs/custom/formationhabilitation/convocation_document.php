...
/**
 *  \file       convocation_document.php
 *  \ingroup    formationhabilitation
 *  \brief      Tab for documents linked to Convocation
 */
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->formationhabilitation->multidir_output[$object->entity ? $object->entity : $conf->entity]."/convocation/".get_exdir(0, 0, 0, 1, $object);
}
...
// Header
// ------
$title = $langs->trans("Convocation")." - ".$langs->trans("Files");
...
print dol_get_fiche_head($head, 'document', $langs->trans("Convocation"), -1, $object->picto);
...
$param = '&id='.$object->id;
//$relativepathwithnofile='convocation/' . dol_sanitizeFileName($object->id).'/';
$relativepathwithnofile = 'convocation/'.dol_sanitizeFileName($object->ref).'/';
