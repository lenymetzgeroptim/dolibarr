...
/**
 *  \file       visitemedical_contact.php
 *  \ingroup    formationhabilitation
 *  \brief      Tab for contacts linked to VisiteMedical
 */
...
$title = $langs->trans("VisiteMedical")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("VisiteMedical"), -1, $object->picto);
