...
/**
 *  \file       volet_agenda.php
 *  \ingroup    formationhabilitation
 *  \brief      Tab of events on Volet
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Volet")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Volet"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_volet_'.$object->id;
