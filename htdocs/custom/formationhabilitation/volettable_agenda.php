...
/**
 *  \file       volettable_agenda.php
 *  \ingroup    formationhabilitation
 *  \brief      Tab of events on VoletTable
 */
...
if ($object->id > 0) {
	$title = $langs->trans("VoletTable")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("VoletTable"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_volettable_'.$object->id;
