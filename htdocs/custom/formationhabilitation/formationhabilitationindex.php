...
$langs->loadLangs(array("formationhabilitation@formationhabilitation", "errors"));
...
// Security check
if (!$conf->formationhabilitation->enabled) {
	accessforbidden();
}
if (!$user->rights->formationhabilitation->userformation->read && !$user->rights->formationhabilitation->userformation->readall &&
!$user->rights->formationhabilitation->userhabilitation_autorisation->read && !$user->rights->formationhabilitation->userhabilitation_autorisation->readall &&
!$user->rights->formationhabilitation->uservolet->read && !$user->rights->formationhabilitation->uservolet->readall &&
!$user->rights->formationhabilitation->visitemedical->read && !$user->rights->formationhabilitation->visitemedical->readall
) {
	accessforbidden();
}
...
// Security check
if ($onglet == 'formation' && !$user->rights->formationhabilitation->userformation->read && !$user->rights->formationhabilitation->userformation->readall) {
	print '<div class="error">'.$langs->trans("ErrorForbidden").'</div>';
}
elseif ($onglet == 'habilitation' && !$user->rights->formationhabilitation->userhabilitation_autorisation->read && !$user->rights->formationhabilitation->userhabilitation_autorisation->readall) {
	print '<div class="error">'.$langs->trans("ErrorForbidden").'</div>';
}
elseif ($onglet == 'autorisation' && !$user->rights->formationhabilitation->userhabilitation_autorisation->read && !$user->rights->formationhabilitation->userhabilitation_autorisation->readall) {
	print '<div class="error">'.$langs->trans("ErrorForbidden").'</div>';
}
elseif ($onglet == 'volet' && !$user->rights->formationhabilitation->uservolet->read && !$user->rights->formationhabilitation->uservolet->readall) {
	print '<div class="error">'.$langs->trans("ErrorForbidden").'</div>';
}
elseif ($onglet == 'visitemedical' && !$user->rights->formationhabilitation->visitemedical->read && !$user->rights->formationhabilitation->visitemedical->readall) {
	print '<div class="error">'.$langs->trans("ErrorForbidden").'</div>';
}
else {
	// Filtres 
