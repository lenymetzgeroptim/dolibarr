...
/**
 *  \file       formation_prerequis.php
 *  \ingroup    formationhabilitation
 *  \brief      Tab for prerequis on Formation
 */
...
$hookmanager->initHooks(array('formationprerequis', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Formation'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'prerequis', $langs->trans("Formation"), -1, $object->picto);
