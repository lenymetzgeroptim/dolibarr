...
/**
 *  \file       habilitation_note.php
 *  \ingroup    formationhabilitation
 *  \brief      Tab for notes on Habilitation
 */
...
$help_url = '';
llxHeader('', $langs->trans('Habilitation'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Habilitation"), -1, $object->picto);
