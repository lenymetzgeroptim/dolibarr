...
/**
 *  \file       htdocs/modulebuilder/template/habilitation_agenda.php
 *  \ingroup    formationhabilitation
 *  \brief      Tab of events on habilitation
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Habilitation")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("habilitation"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_habilitation_'.$object->id;
