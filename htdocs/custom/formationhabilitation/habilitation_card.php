...
if ($action == 'create') {
	...
	print load_fiche_titre($langs->trans("NewObj", $langs->transnoentitiesnoconv("Habilitation")), '', $object->picto);
...
if (($id || $ref) && $action == 'edit') {
	print load_fiche_titre($langs->trans("Habilitation"), '', $object->picto);
