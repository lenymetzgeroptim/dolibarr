...
/**
 *   	\file       habilitation_card.php
 *		\ingroup    formationhabilitation
 *		\brief      Page to create/edit/view habilitation
 */
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'habilitationcard'; // To manage different context of search
...
if ($action == 'create') {
	...
	print load_fiche_titre($langs->trans("NewObj", $langs->transnoentitiesnoconv("Habilitation")), '', 'fa-gear_fa_#c46c0e');
...
if (($id || $ref) && $action == 'edit') {
	print load_fiche_titre($langs->trans("Habilitation"), '', 'fa-gear_fa_#c46c0e');
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create'))) {
	...
	print dol_get_fiche_head($head, 'card', $langs->trans("Habilitation"), -1, $object->picto);
	...
	// Common attributes
	$keyforbreak='volet';	// We change column just before this field
