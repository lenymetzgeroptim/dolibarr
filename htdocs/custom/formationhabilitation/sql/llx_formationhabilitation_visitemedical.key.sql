...
ALTER TABLE llx_formationhabilitation_visitemedical ADD INDEX idx_formationhabilitation_visitemedical_fk_soc (fk_soc);
ALTER TABLE llx_formationhabilitation_visitemedical ADD INDEX idx_formationhabilitation_visitemedical_fk_project (fk_project);
ALTER TABLE llx_formationhabilitation_visitemedical ADD CONSTRAINT llx_formationhabilitation_visitemedical_fk_user_creat FOREIGN KEY (fk_user_creat) REFERENCES llx_user(rowid);
