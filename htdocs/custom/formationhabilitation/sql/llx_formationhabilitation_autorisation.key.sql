...
--ALTER TABLE llx_formationhabilitation_autorisation ADD UNIQUE INDEX uk_formationhabilitation_autorisation_fieldxy(fieldx, fieldy);

--ALTER TABLE llx_formationhabilitation_autorisation ADD CONSTRAINT llx_formationhabilitation_autorisation_fk_field FOREIGN KEY (fk_field) REFERENCES llx_formationhabilitation_myotherobject(rowid);
