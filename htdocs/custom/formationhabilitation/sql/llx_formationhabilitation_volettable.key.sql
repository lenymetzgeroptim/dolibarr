...
--ALTER TABLE llx_formationhabilitation_volettable ADD UNIQUE INDEX uk_formationhabilitation_volettable_fieldxy(fieldx, fieldy);

--ALTER TABLE llx_formationhabilitation_volettable ADD CONSTRAINT llx_formationhabilitation_volettable_fk_field FOREIGN KEY (fk_field) REFERENCES llx_formationhabilitation_myotherobject(rowid);
