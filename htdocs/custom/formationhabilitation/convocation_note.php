...
/**
 *  \file       convocation_note.php
 *  \ingroup    formationhabilitation
 *  \brief      Tab for notes on Convocation
 */
...
$title = $langs->trans('Convocation').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Convocation"), -1, $object->picto);
