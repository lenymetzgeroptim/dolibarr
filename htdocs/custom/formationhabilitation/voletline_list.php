...
/**
 *   	\file       voletline_list.php
 *		\ingroup    formationhabilitation
 *		\brief      List page for voletline
 */
...
require_once __DIR__.'/class/voletline.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontodelete = $user->hasRight('formationhabilitation', 'voletline', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'VoletLine';
	$objectlabel = 'VoletLine';
...
$title = $langs->trans("VoletLines");
//$help_url = "EN:Module_VoletLine|FR:Module_VoletLine_FR|ES:Módulo_VoletLine";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/formationhabilitation/voletline_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/formationhabilitation/voletline_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendVoletLineRef";
$modelmail = "voletline";
$objecttmp = new VoletLine($db);
