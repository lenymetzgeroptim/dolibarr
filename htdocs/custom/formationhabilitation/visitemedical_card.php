...
if ($enablepermissioncheck) {
	...
	$permissiontodelete = $user->hasRight('formationhabilitation', 'visitemedical', 'delete') || ($permissiontoadd && isset($object->status) && $object->status == $object::STATUS_DRAFT);
...
if ($action == 'create') {
	$title = $langs->trans("NewObject", $langs->transnoentitiesnoconv("VisiteMedical"));
}
$help_url = '';
