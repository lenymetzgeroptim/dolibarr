...
$hookmanager->initHooks(array('formationhabilitationsetup', 'globalsetup'));
...
if ($action == 'updateMask') {
	...
	if ($filefound) {
		...
		if ($module->write_file($tmpobject, $langs) > 0) {
			header("Location: ".DOL_URL_ROOT."/document.php?modulepart=formationhabilitation-".strtolower($tmpobjectkey)."&file=SPECIMEN.pdf");
			return;
		} else {
...
print dol_get_fiche_head($head, 'settings', $langs->trans($page_name), -1, "formationhabilitation@formationhabilitation");

// Setup page goes here
echo '<span class="opacitymedium">'.$langs->trans("FormationHabilitationSetupPage").'</span><br><br>';
