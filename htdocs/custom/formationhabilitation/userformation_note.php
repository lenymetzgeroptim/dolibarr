...
$hookmanager->initHooks(array('userformationnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('UserFormation'), $help_url);
