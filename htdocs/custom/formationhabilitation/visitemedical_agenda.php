...
/**
 *  \file       visitemedical_agenda.php
 *  \ingroup    formationhabilitation
 *  \brief      Tab of events on VisiteMedical
 */
...
if ($object->id > 0) {
	$title = $langs->trans("VisiteMedical")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("VisiteMedical"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_visitemedical_'.$object->id;
