...
/**
 *   	\file       userformation_list.php
 *		\ingroup    formationhabilitation
 *		\brief      List page for userformation
 */
...
require_once __DIR__.'/class/userformation.class.php';
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'userformationlist'; // To manage different context of search
...
$hookmanager->initHooks(array('userformationlist')); // Note that conf->hooks_modules contains array
...
//$help_url="EN:Module_UserFormation|FR:Module_UserFormation_FR|ES:Módulo_UserFormation";
$help_url = '';
$title = $langs->trans('ListOf', $langs->transnoentitiesnoconv("UserFormations"));
$morejs = array();
$morecss = array();
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/formationhabilitation/userformation_card.php', 1).'?id='.$id);
	exit;
}
