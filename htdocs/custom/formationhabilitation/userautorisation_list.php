...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('formationhabilitation', 'userautorisation', 'write');
	$permissiontodelete = $user->hasRight('formationhabilitation', 'userautorisation', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
