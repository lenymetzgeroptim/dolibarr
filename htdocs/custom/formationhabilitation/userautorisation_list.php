...
/**
 *   	\file       userautorisation_list.php
 *		\ingroup    formationhabilitation
 *		\brief      List page for userautorisation
 */
...
require_once __DIR__.'/class/userautorisation.class.php';
...
$permissiontoread = $user->hasRight('formationhabilitation', 'userhabilitation_autorisation', 'readall');
$permissiontoadd = $user->hasRight('formationhabilitation', 'userhabilitation_autorisation', 'write');
$permissiontodelete = $user->hasRight('formationhabilitation', 'userhabilitation_autorisation', 'delete');
...
$title = $langs->trans("UserAutorisations");
//$help_url = "EN:Module_UserAutorisation|FR:Module_UserAutorisation_FR|ES:Módulo_UserAutorisation";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/formationhabilitation/userautorisation_card.php', 1).'?id='.((int) $id));
	exit;
}
...
// $newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/formationhabilitation/userautorisation_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);
