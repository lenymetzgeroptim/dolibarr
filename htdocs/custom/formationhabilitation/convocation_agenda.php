...
/**
 *  \file       convocation_agenda.php
 *  \ingroup    formationhabilitation
 *  \brief      Tab of events on Convocation
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Convocation")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Convocation"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_convocation_'.$object->id;
