...
/**
 * \file    test/phpunit/FormationHabilitationFunctionalTest.php
...
/**
 * Class FormationHabilitationFunctionalTest
 *
 ...
 *
 * @package Testformationhabilitation
 */
class FormationHabilitationFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modFormationHabilitation')->click();
		} else {
			// Disable the module
			$this->byHref('modFormationHabilitation')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/formationhabilitation/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('formationhabilitation/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/formationhabilitation/admin/about.php');
		$this->authenticate();
		return $this->assertContains('formationhabilitation/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('formationhabilitationwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modFormationHabilitation_FormationHabilitationTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFormationHabilitation_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
