...
/**
 *   	\file       elementprerequis_list.php
 *		\ingroup    formationhabilitation
 *		\brief      List page for elementprerequis
 */
...
require_once __DIR__.'/class/elementprerequis.class.php';
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'ElementPrerequis';
	$objectlabel = 'ElementPrerequis';
...
$title = $langs->trans("ElementPrerequiss");
//$help_url = "EN:Module_ElementPrerequis|FR:Module_ElementPrerequis_FR|ES:Módulo_ElementPrerequis";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/formationhabilitation/elementprerequis_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/formationhabilitation/elementprerequis_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendElementPrerequisRef";
$modelmail = "elementprerequis";
$objecttmp = new ElementPrerequis($db);
