...
/**
 *   	\file       autorisation_list.php
 *		\ingroup    formationhabilitation
 *		\brief      List page for autorisation
 */
...
require_once __DIR__.'/class/autorisation.class.php';
...
$permissiontoadd = $user->hasRight('formationhabilitation', 'habilitation_autorisation', 'write');
$permissiontodelete = $user->hasRight('formationhabilitation', 'habilitation_autorisation', 'delete');
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Autorisation';
	$objectlabel = 'Autorisation';
...
$title = $langs->trans("Autorisations");
//$help_url = "EN:Module_Autorisation|FR:Module_Autorisation_FR|ES:Módulo_Autorisation";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/formationhabilitation/autorisation_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/formationhabilitation/autorisation_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendAutorisationRef";
$modelmail = "autorisation";
$objecttmp = new Autorisation($db);
