...
class Formation extends CommonObject
{
	...
	public $fields=array(
		...
		'periode_recyclage' => array('type'=>'integer', 'label'=>'PeriodeRecyclage', 'enabled'=>'1', 'position'=>35, 'notnull'=>0, 'visible'=>1, 'help'=>"en jour",),
		...
		'famille' => array('type'=>'sellist:famille_formation:label:rowid::active=1', 'label'=>'Famille', 'enabled'=>'1', 'position'=>32, 'notnull'=>1, 'visible'=>1,),
		...
		'prerequis' => array('type'=>'chkbxlst:formationhabilitation_formation:ref|label:rowid', 'label'=>'Prerequis', 'enabled'=>'1', 'position'=>50, 'notnull'=>0, 'visible'=>1,),
	);
	public $rowid;
	public $ref;
	public $label;
	 ...
	 */
	public $table_element_line = 'formationhabilitation_user_formation';
	 ...
	 */
	public $class_element_line = 'User_formation';
	 ...
	 */
	protected $childtablesoncascade = array('formationhabilitation_user_formation');
	...
	public function fetchLines()
	{
		...
		$objectlineclassname = 'User_formation';
		...
		$sql .= " FROM ".$this->db->prefix()."formationhabilitation_user_formation as l";
	...
	public function getLinesArray()
	{
		...
		$result = $objectline->fetchAll('ASC', 'rowid', 0, 0, array('customsql'=>'fk_formation = '.((int) $this->id)));
