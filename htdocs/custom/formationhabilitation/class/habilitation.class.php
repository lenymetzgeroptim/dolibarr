...
class Habilitation extends CommonObject
{
	 ...
	 */
	public $picto = 'fa-gear_fa_#c46c0e';
	 ...
	 */
	public $table_element_line = 'formationhabilitation_user_habilitation';
	 ...
	 */
	public $class_element_line = 'User_habilitation';

	/**
	 * @var array	List of child tables. To test if we can delete object.
	 */
	//protected $childtables = array('formationhabilitation_user_habilitation');
	 ...
	 */
	protected $childtablesoncascade = array('formationhabilitation_user_habilitation');
	...
	public function fetchLines()
	{
		...
		$objectlineclassname = 'User_habilitation';
		...
		$sql .= " FROM ".$this->db->prefix()."formationhabilitation_user_habilitation as l";
	...
	public function getLinesArray()
	{
		...
		$result = $objectline->fetchAll('ASC', 'rowid', 0, 0, array('customsql'=>'fk_habilitation = '.((int) $this->id)));
