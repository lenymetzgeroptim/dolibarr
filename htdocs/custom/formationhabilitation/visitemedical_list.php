...
/**
 *   	\file       visitemedical_list.php
 *		\ingroup    formationhabilitation
 *		\brief      List page for visitemedical
 */
...
require_once __DIR__.'/class/visitemedical.class.php';
...
$title = $langs->trans("VisiteMedicals");
//$help_url = "EN:Module_VisiteMedical|FR:Module_VisiteMedical_FR|ES:Módulo_VisiteMedical";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/formationhabilitation/visitemedical_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/formationhabilitation/visitemedical_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);
