...
class modFormationHabilitation extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->tabs = array(
			'data'=>'user:+user_formation:Formation - Habilitation:formationhabilitation@formationhabilitation:$user->rights->formationhabilitation->formation->addline||$user->id==$object->id:/formationhabilitation/user_formation.php?id=__ID__'
		);
		// Example:
		...
		$this->dictionaries=array(
			...
			'tabname'=>array(MAIN_DB_PREFIX."famille_formation"),
			// Label of tables
			'tablib'=>array("FamilleFormation"),
			// Request to select fields
			'tabsql'=>array('SELECT f.rowid as rowid, f.label, f.active FROM '.MAIN_DB_PREFIX.'famille_formation as f'),
			// Sort order
			...
			'tabcond'=>array($conf->formationhabilitation->enabled)
		);
		...
		$this->cronjobs = array(
			0 => array(
				...
				'jobtype' => 'method',
				'class' => '/formationhabilitation/class/user_formation.class.php',
				'objectname' => 'User_formation',
				'method' => 'MajStatuts',
				'parameters' => '',
