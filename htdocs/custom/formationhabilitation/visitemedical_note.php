...
/**
 *  \file       visitemedical_note.php
 *  \ingroup    formationhabilitation
 *  \brief      Tab for notes on VisiteMedical
 */
...
$title = $langs->trans('VisiteMedical').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("VisiteMedical"), -1, $object->picto);
