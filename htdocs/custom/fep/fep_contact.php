...
/**
 *  \file       fep_contact.php
 *  \ingroup    fep
 *  \brief      Tab for contacts linked to FEP
 */
...
$hookmanager->initHooks(array('fepcontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->fep->fep->write;
...
$title = $langs->trans('FEP')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
