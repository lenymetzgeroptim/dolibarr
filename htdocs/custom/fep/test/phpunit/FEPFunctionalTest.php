...
/**
 * \file    test/phpunit/FEPFunctionalTest.php
 * \ingroup fep
 ...
 * @package Testfep
 */
class FEPFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/fep/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('fep/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/fep/admin/about.php');
		$this->authenticate();
		return $this->assertContains('fep/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('fepwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modFEP_FEPTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFEP_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
