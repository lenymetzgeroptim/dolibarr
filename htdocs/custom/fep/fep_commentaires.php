...
print dol_get_fiche_head($head, 'fep_commentaires', $langs->trans("Workstation"), -1, $object->picto);
...
if ($object->status == $object::STATUS_COMMENTAIRE) {
	...
	print dolGetButtonAction($langs->trans('Modify'), '', 'default', '/erp/custom/fep/fep_card.php'.'?id='.$object->id.'&action=editcommentaires&token='.newToken(), '', $permissiontoadd);
	print '</div>'."\n";
}
