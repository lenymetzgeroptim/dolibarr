...
dol_include_once('/fep/class/myobject.class.php');
dol_include_once('/fep/lib/fep_myobject.lib.php');
...
$permission = $user->rights->fep->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/fep/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
