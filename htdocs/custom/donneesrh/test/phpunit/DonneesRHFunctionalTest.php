...
/**
 * \file    test/phpunit/DonneesRHFunctionalTest.php
 * \ingroup donneesrh
 ...
 *
 * @package Testdonneesrh
 */
class DonneesRHFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 500024; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDonneesRH')->click();
		} else {
			// Disable the module
			$this->byHref('modDonneesRH')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/donneesrh/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('donneesrh/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/donneesrh/admin/about.php');
		$this->authenticate();
		return $this->assertContains('donneesrh/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('donneesrhwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDonneesRH_DonneesRHTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDonneesRH_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
