...
<input type="hidden" name="action" value="update_extrafield">
...
<!-- Onglet -->
<!-- <?php
	$param_list[0] = 'OngletDonneesRH:custom/donneesrh/class/ongletdonneesrh.class.php'; // $param_list='ObjectName:classPath[:AddCreateButtonOrNot[:Filter[:Sortfield]]]'
	...
	$value = $object->id;
	$out = $form->selectForForms($param_list[0], 'onglet', $value, $showempty, '', '', $morecss, '', 0, 0);
?>
<tr class="extra_groupes"><td class="fieldrequired"><?php echo $langs->trans("Onglet Données RH"); ?></td><td><?php echo $out; ?></td></tr> -->
...
<input type="submit" name="button" class="button button-cancel" value="<?php echo $langs->trans("Cancel"); ?>"></div><br>
