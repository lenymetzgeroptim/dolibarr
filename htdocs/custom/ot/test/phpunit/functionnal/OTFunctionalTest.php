...
/**
 * \file    test/phpunit/OTFunctionalTest.php
 * \ingroup ot
 ...
 * @package Testot
 */
class OTFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 700003; // TODO: autodetect?
	...
	{
		$this->url('/custom/ot/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('ot/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/ot/admin/about.php');
		$this->authenticate();
		return $this->assertContains('ot/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('otwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modOT_OTTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modOT_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
