...
/**
 *  \file       remonteessse_note.php
 *  \ingroup    remonteessse
 *  \brief      Tab for notes on RemonteesSse
 */
...
$hookmanager->initHooks(array('remonteesssenote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('RemonteesSse'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("RemonteesSse"), -1, $object->picto);
