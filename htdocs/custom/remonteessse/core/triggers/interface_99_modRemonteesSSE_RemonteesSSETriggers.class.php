	...
	public function runTrigger($action, $object, User $user, Translate $langs, Conf $conf)
	{
		...
		switch ($action) {
			...
			case 'REMONTEES_SSE_VALIDATE':
				...
				$link = '<a href="'.$urlwithroot.'/custom/remonteessse/remontees_sse_card.php?id='.$object->id.'">'.$object->libelle.'</a>';
			...
			case 'REMONTEES_SSE_PRISEENCOMPTE':
				$res = 1;
			...
			/*case 'REMONTEES_SSE_ANNULATION':
				...
				$urlwithouturlroot = preg_replace('/'.preg_quote(DOL_URL_ROOT, '/').'$/i', '', trim($dolibarr_main_url_root));
				$urlwithroot = $urlwithouturlroot.DOL_URL_ROOT; // This is to use external domain name found into config file
				$link = '<a href="'.$urlwithroot.'/custom/remonteessse/remontees_sse_card.php?id='.$object->id.'">'.$object->ref.'</a>';
