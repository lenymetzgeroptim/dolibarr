...
/**
 * \file    test/phpunit/RemonteesSSEFunctionalTest.php
...
/**
 * Class RemonteesSSEFunctionalTest
 *
 ...
 *
 * @package Testremonteessse
 */
class RemonteesSSEFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modRemonteesSSE')->click();
		} else {
			// Disable the module
			$this->byHref('modRemonteesSSE')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/remonteessse/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('remonteessse/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/remonteessse/admin/about.php');
		$this->authenticate();
		return $this->assertContains('remonteessse/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('remonteesssewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modRemonteesSSE_RemonteesSSETriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modRemonteesSSE_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
