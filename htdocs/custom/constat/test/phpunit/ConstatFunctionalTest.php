...
/**
 * \file    test/phpunit/ConstatFunctionalTest.php
 * \ingroup constat
 ...
 * @package Testconstat
 */
class ConstatFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 500029; // TODO: autodetect?
	...
	{
		$this->url('/custom/constat/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('constat/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/constat/admin/about.php');
		$this->authenticate();
		return $this->assertContains('constat/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('constatwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modConstat_ConstatTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modConstat_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
