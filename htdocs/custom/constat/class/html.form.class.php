...
class actionsForm extends Form 
{
	 ...
	 */
	// public function showLinkedObjectBlockCustom($object, $morehtmlright = '', $compatibleImportElementsList = false)
	// {
	...
	// 	);
	// 	$reshook = $hookmanager->executeHooks('showLinkedObjectBlockCustom', $parameters, $object, $action); // Note that $action and $object may have been modified by hook

	// 	if (empty($reshook)) {
	// 		$nbofdifferenttypes = count($object->linkedObjects);

	// 		print '<!-- showLinkedObjectBlockCustom -->';
	// 		print load_fiche_titre($langs->trans('RelatedObjects'), $morehtmlright, '', 0, 0, 'showLinkedObjectBlockCustom');
    ...
    //                  $res = @include DOL_DOCUMENT_ROOT.'/custom/constat/core/tpl/linkedobjectblock.tpl.php';
