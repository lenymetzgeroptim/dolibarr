...
class Constat extends CommonObject
{
	...
	public $fields=array(
		...
		"ref" => array("type"=>"varchar(128)", "label"=>"Ref", "enabled"=>"1", 'position'=>20, 'notnull'=>1, "visible"=>"\$object->status>0?1:0", "default"=>"(PROV)", "index"=>"1", "searchall"=>"1", "showoncombobox"=>"1", "validate"=>"1", "comment"=>"Reference of object"),
