...
class Constat extends CommonObject
{
	 ...
	 */
	public $picto = 'fa-clipboard-check_fas_#bd6e00';

	public $labelStatusExplication = array();
	...
	public $fields=array(
		...
		"sujet" => array("type"=>"sellist:c_constat_sujet:label:rowid::(active:=:1)", "label"=>"Typologie", "enabled"=>"1", 'position'=>110, 'notnull'=>1, "visible"=>"1", "csslist"=>"150",),
		...
		"num_commande" => array("type"=>"chkbxlst:commande:ref:rowid", "label"=>"NumCommande", "enabled"=>"1", 'position'=>200, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?1:0",),
		"type_constat" => array("type"=>"sellist:c_constat_type:label:rowid::(active:=:1)", "label"=>"TypeConstat", "enabled"=>"1", 'position'=>201, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?1:0",),
		"rubrique" => array("type"=>"chkbxlst:c_constat_rubrique:label:rowid::(active=1)", "label"=>"Rubrique", "enabled"=>"1", 'position'=>202, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?1:0",),
		"processus" => array("type"=>"chkbxlst:c_constat_processus:label:rowid::(active=1)", "label"=>"Processus", "enabled"=>"1", 'position'=>203, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?1:0",),
		"actionsimmediates" => array("type"=>"integer", "label"=>"ActionsImmediates", "enabled"=>"1", 'position'=>210, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?1:0", "css"=>"linebreak", "help"=>"Cocher si le constat est une action immédiate", "arrayofkeyval"=>array("1" => "Oui", "2" => "Non"),),
		"actionsimmediates_date" => array("type"=>"date", "label"=>"ActionsImmediatesDate", "enabled"=>"1", 'position'=>211, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?1:0",),
		"actionsimmediates_par" => array("type"=>"varchar(64)", "label"=>"ActionsImmediatesPar", "enabled"=>"1", 'position'=>212, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?1:0",),
		"actionsimmediates_commentaire" => array("type"=>"html", "label"=>"ActionsImmediatesComm", "enabled"=>"1", 'position'=>213, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?-1:0", "cssview"=>"wordbreak", "help"=>"Détail action immédiate (Quoi, Qui, Où, Quand, Comment, Combien, Pourquoi)",),
		"infoclient" => array("type"=>"integer", "label"=>"InfoClient", "enabled"=>"1", 'position'=>220, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?1:0", "help"=>"Client informé requis ou non", "arrayofkeyval"=>array("1" => "Oui", "2" => "Non"),),
		"infoclient_date" => array("type"=>"date", "label"=>"InfoClientDate", "enabled"=>"1", 'position'=>221, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?1:0",),
		"infoclient_par" => array("type"=>"varchar(64)", "label"=>"InfoClientPar", "enabled"=>"1", 'position'=>222, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?1:0",),
		"infoclient_commentaire" => array("type"=>"html", "label"=>"InfoClientComm", "enabled"=>"1", 'position'=>223, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?-1:0", "help"=>"Préciser la méthode d'information client",),
		"impact" => array("type"=>"chkbxlst:c_constat_impact:label:rowid::(active=1)", "label"=>"Impact", "enabled"=>"1", 'position'=>230, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?1:0",),
		"cout_total" => array("type"=>"int", "label"=>"CoutTotal", "enabled"=>"1", 'position'=>240, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?1:0", "help"=>"Coût total regroupant : le coût de traitement horraire, le coût de traitement financier et le coût de pénalité</br>0 possible",),
		"commentaire_resp_aff" => array("type"=>"html", "label"=>"CommRespAff", "enabled"=>"1", 'position'=>250, 'notnull'=>0, "visible"=>"\$object->status>0||!\$object->id?-1:0",),
		"analyse_cause_racine" => array("type"=>"html", "label"=>"AnalyseCausesRacines", "enabled"=>"1", 'position'=>300, 'notnull'=>0, "visible"=>"\$object->status>1||!\$object->id?-1:0", "cssview"=>"wordbreak", "help"=>"5M, Arbre des causes, description détaillée, etc.",),
		"recurent" => array("type"=>"integer", "label"=>"Recurent", "enabled"=>"1", 'position'=>310, 'notnull'=>0, "visible"=>"\$object->status>1||!\$object->id?1:0", "help"=>"Cocher si le constat est récurent", "arrayofkeyval"=>array("1" => "Oui", "2" => "Non"),),
		"accordclient" => array("type"=>"integer", "label"=>"AccordClient", "enabled"=>"1", 'position'=>320, 'notnull'=>0, "visible"=>"\$object->status>1||!\$object->id?1:0", "help"=>"Accord client requis ou non", "arrayofkeyval"=>array("1" => "Oui", "2" => "Non"),),
		"accordclient_date" => array("type"=>"date", "label"=>"AccordClientDate", "enabled"=>"1", 'position'=>321, 'notnull'=>0, "visible"=>"\$object->status>1||!\$object->id?1:0",),
		"accordclient_par" => array("type"=>"varchar(64)", "label"=>"AccordClientPar", "enabled"=>"1", 'position'=>322, 'notnull'=>0, "visible"=>"\$object->status>1||!\$object->id?1:0",),
		"accordclient_commentaire" => array("type"=>"html", "label"=>"AccordClientComm", "enabled"=>"1", 'position'=>323, 'notnull'=>0, "visible"=>"\$object->status>1||!\$object->id?-1:0", "help"=>"Préciser la méthode d'information client",),
		"controleclient" => array("type"=>"integer", "label"=>"ControleClient", "enabled"=>"1", 'position'=>330, 'notnull'=>0, "visible"=>"\$object->status>1||!\$object->id?1:0", "help"=>"Contrôle du client requis ou non", "arrayofkeyval"=>array("1" => "Oui", "2" => "Non"),),
		"controleclient_date" => array("type"=>"date", "label"=>"ControleClientDate", "enabled"=>"1", 'position'=>331, 'notnull'=>0, "visible"=>"\$object->status>1||!\$object->id?1:0",),
		"controleclient_par" => array("type"=>"varchar(64)", "label"=>"ControleClientPar", "enabled"=>"1", 'position'=>332, 'notnull'=>0, "visible"=>"\$object->status>1||!\$object->id?1:0",),
		"controleclient_commentaire" => array("type"=>"html", "label"=>"ControleClientComm", "enabled"=>"1", 'position'=>333, 'notnull'=>0, "visible"=>"\$object->status>1||!\$object->id?-1:0", "help"=>"Préciser la méthode d'information client",),
		"commentaire_resp_q3se" => array("type"=>"html", "label"=>"CommentaireRespQ3SE", "enabled"=>"1", 'position'=>350, 'notnull'=>0, "visible"=>"\$object->status>1||!\$object->id?-1:0",),
		"commentaire_serv_q3se" => array("type"=>"html", "label"=>"CommentaireServQ3SE", "enabled"=>"1", 'position'=>351, 'notnull'=>0, "visible"=>"\$object->status>1||!\$object->id?-1:0",),
		"last_main_doc" => array("type"=>"varchar(255)", "label"=>"LastMainDoc", "enabled"=>"1", 'position'=>650, 'notnull'=>0, "visible"=>"0",),
		"cloture_date" => array("type"=>"date", "label"=>"ClotureDate", "enabled"=>"1", 'position'=>400, 'notnull'=>0, "visible"=>"\$object->status>1||!\$object->id?1:0", "help"=>"Date à remplir lorsque le constat est soldé",),
		"cloture_par" => array("type"=>"varchar(64)", "label"=>"CloturePar", "enabled"=>"1", 'position'=>401, 'notnull'=>0, "visible"=>"\$object->status>1||!\$object->id?1:0",),
	...
	public $fk_project;
	public $site;
	public $emetteur_date;
	public $sujet;
	public $description_constat;
	public $description_impact;
	public $commentaire_emetteur;
	public $num_commande;
	public $type_constat;
	public $rubrique;
	public $processus;
	...
	public function __construct(DoliDB $db)
	{
		...
		$this->fields['label']['separation'] = 1;
		$this->fields['label']['label_separation'] = "Identification de l'émetteur";

		$this->fields['num_commande']['separation'] = 1;
		$this->fields['num_commande']['label_separation'] = "Responsable d'affaire";

		$this->fields['analyse_cause_racine']['separation'] = 1;
		$this->fields['analyse_cause_racine']['label_separation'] = "Service Q3SE";

		$this->fields['actionsimmediates']['trbreak'] = 'bottom';
		$this->fields['infoclient']['trbreak'] = "top_bottom";
		$this->fields['impact']['trbreak'] = "top";
		$this->fields['accordclient']['trbreak'] = 'bottom';
		$this->fields['controleclient']['trbreak'] = "top_bottom";
		$this->fields['commentaire_resp_q3se']['trbreak'] = "top";

		$this->labelStatusExplication[self::STATUS_DRAFT] = $langs->transnoentitiesnoconv('ConstatDraftExplication');
		$this->labelStatusExplication[self::STATUS_VALIDATED] = $langs->transnoentitiesnoconv('ConstatValidatedExplication');
		$this->labelStatusExplication[self::STATUS_EN_COURS] = $langs->transnoentitiesnoconv('ConstatEncoursExplication');
	...
	public function fetch($id, $ref = null)
	{
		...
		if($this->status >= self::STATUS_DRAFT) {
			$this->fields['label']['notnull_validate'] = 1;
			$this->fields['fk_user']['notnull_validate'] = 1;
			$this->fields['fk_project']['notnull_validate'] = 1;
			$this->fields['site']['notnull_validate'] = 1;
			$this->fields['emetteur_date']['notnull_validate'] = 1;
			$this->fields['sujet']['notnull_validate'] = 1;
			$this->fields['description_constat']['notnull_validate'] = 1;
			$this->fields['description_impact']['notnull_validate'] = 1;
		}
		if($this->status >= self::STATUS_VALIDATED) {
			$this->fields['num_commande']['notnull_validate'] = 1;
			$this->fields['type_constat']['notnull_validate'] = 1;
			$this->fields['rubrique']['notnull_validate'] = 1;
			$this->fields['processus']['notnull_validate'] = 1;
			$this->fields['actionsimmediates']['notnull_validate'] = 1;
			if($this->actionsimmediates == 1) {
				$this->fields['actionsimmediates_date']['notnull_validate'] = 1;
				$this->fields['actionsimmediates_par']['notnull_validate'] = 1;
			}
			$this->fields['actionsimmediates_commentaire']['notnull_validate'] = 1;
			$this->fields['infoclient']['notnull_validate'] = 1;
			if($this->infoclient == 1) {
				$this->fields['infoclient_date']['notnull_validate'] = 1;
				$this->fields['infoclient_par']['notnull_validate'] = 1;
			}
		...
		if($this->status >= self::STATUS_EN_COURS) {
			...
			$this->fields['recurent']['notnull_validate'] = 1;
			$this->fields['accordclient']['notnull_validate'] = 1;
			if($this->accordclient == 1) {
				$this->fields['accordclient_date']['notnull_validate'] = 1;
				$this->fields['accordclient_par']['notnull_validate'] = 1;
			}
			$this->fields['accordclient_commentaire']['notnull_validate'] = 1;
			$this->fields['controleclient']['notnull_validate'] = 1;
			if($this->controleclient == 1) {
				$this->fields['controleclient_date']['notnull_validate'] = 1;
	...
	*/
	...
	public function getActionsUnsold() {
		global $db;

		$actions_unsold = array();
		...
		if ($result) {
			...
			while ($i < $num) {
				$obj = $db->fetch_object($result);
				$actions_unsold[$obj->fk_source][$obj->fk_target] = $obj;
				$i++;
			}
