...
require_once __DIR__.'/class/rubrique.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('constat', 'rubrique', 'write');
	$permissiontodelete = $user->hasRight('constat', 'rubrique', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Rubrique';
	$objectlabel = 'Rubrique';
...
$title = $langs->trans("Rubriques");
//$help_url = "EN:Module_Rubrique|FR:Module_Rubrique_FR|ES:Módulo_Rubrique";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/constat/rubrique_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/constat/rubrique_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendRubriqueRef";
$modelmail = "rubrique";
$objecttmp = new Rubrique($db);
