...
/**
 * \file    constat/core/boxes/constatwidget1.php
 * \ingroup constat
 * \brief   Widget provided by Constat
 *
...
include_once DOL_DOCUMENT_ROOT."/constat/class/constat.class.php";
 ...
 */
class constatwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "constatbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "constat@constat";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "constat@constat"));
		...
		// $this->hidden = !$user->hasRight('constat', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("ConstatBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_constat@constat',
