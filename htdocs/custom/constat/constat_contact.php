...
/**
 *  \file       constat_contact.php
 *  \ingroup    constat
 *  \brief      Tab for contacts linked to Constat
 */
...
$hookmanager->initHooks(array('constatcontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$title = $langs->trans('Constat')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Constat"), -1, $object->picto);
