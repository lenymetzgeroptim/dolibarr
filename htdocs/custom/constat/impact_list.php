...
/**
 *   	\file       impact_list.php
 *		\ingroup    constat
 *		\brief      List page for impact
 */
...
require_once __DIR__.'/class/impact.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('constat', 'impact', 'write');
	$permissiontodelete = $user->hasRight('constat', 'impact', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
$title = $langs->trans("Impacts");
//$help_url = "EN:Module_Impact|FR:Module_Impact_FR|ES:Módulo_Impact";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/constat/impact_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/constat/impact_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendImpactRef";
$modelmail = "impact";
$objecttmp = new Impact($db);
