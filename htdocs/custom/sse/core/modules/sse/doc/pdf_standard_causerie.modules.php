...
/**
 *  \file       core/modules/sse/doc/pdf_standard.modules.php
 *  \ingroup    sse
...
/**
 *	Class to manage PDF template standard_causerie
 */
class pdf_standard_causerie extends ModelePDFCauserie
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_CAUSERIE_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->sse->dir_output.'/causerie') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->sse->dir_output.'/causerie';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->sse->dir_output.'/causerie/'.$objectref;
