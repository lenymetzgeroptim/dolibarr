...
/**
 * \file    test/phpunit/SSEFunctionalTest.php
 * \ingroup sse
 ...
 * @package Testsse
 */
class SSEFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/sse/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('sse/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/sse/admin/about.php');
		$this->authenticate();
		return $this->assertContains('sse/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('ssewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modSSE_SSETriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSSE_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
