...
$user->id == $userid ? $href = dol_buildpath('/sse/causerieattendance_list.php', 1).'#signature' : $href = '#';
...
print '</span>';
print '</td><td class="nobordernopadding valignmiddle col-title"><div class="titre inline-block">Espace causerie - '.$participant->firstname.' '.$participant->lastname.'</div></td>';
print '</tr>';
print '</table>';
print ' &nbsp; ';
...
print '<div class="fichecenter"><div class="fichethirdleft">';
$tmp = $object->getCauserieByThemeForUserChart($userid);
if ($tmp) {
	print $tmp;
	print '<br>';
}
...
$sql .= " LEFT JOIN ".MAIN_DB_PREFIX."sseorganisation_theme as t ON t.rowid = ce.thme";
